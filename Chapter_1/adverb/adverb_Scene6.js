...
(lib.Main = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(3,1,1).p("AWyxtIpAABIh/gBIjIAAIh1AAIhaAAIoxAAIi3AAIpFAAQgCAAgDAAInyAAAXHRnIAByMIAAhAIABv+A3CRuIAzAAICbgCIAfAAICKAAIHLAAIAhAAIDYAAIA8AAIB+AAIAlAAICNAAAgZRsIADAAAV+RsIhfAAIhpAAIhaAAIgyAAIg8AAIgwAAIkrAAAWVRsIgXAAAWaRsIgcAA");
	this.shape.setTransform(-0.5,-1.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(3,1,1).p("Awtx2IAAARIAAHZIAAFYIAAOuIAAAtIAAFwIAAAzIAAAtAF/R1IACAAAGER1IAGAAIEvAAIA+AAICbAAIBKAAIBSAA");
	...
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFCC33").s().p("");
	...
	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f().s("#000000").ss(3,1,1).p("");
	...
	this.shape_51.graphics.f("#C6FFFF").s().p("");
	this.shape_51.setTransform(-2,-73.4);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#171717").s().p("");
	...
	this.shape_53.graphics.f().s("#000000").ss(3,1,1).p("");
	this.shape_53.setTransform(-0.5,-2.2);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#00CC00").s().p("AALCLIC7AfIADATQguAag3AGIgLAAQhVAAAHhSgAjuCoIAKhJQAJg7gPg3IgDgLQgFgYgBgXQgDhLAxg5QADAAACABQBXAsBhgHQBxAHBgg4QAIARAFATQAHAVAKATQATAigJAoQgcAPgfgEQi1gTiHBVIAGAMIgBAXQAAAUANALQAwAtA7AgQACAVgFAUQgCALgKgDQgXACgXAAQhWAAhSghg");
	this.shape_54.setTransform(37.9,84.6);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#666666").s().p("Ah/BpQBRibCkhAIAKAIIgfBJQgcBCAEBHQhggFhiAQg");
	this.shape_55.setTransform(77.7,74.1);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#6666CC").s().p("");
	this.shape_56.setTransform(87.5,61.3);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#00CC33").s().p("ADXAGQhcgGhdgCIitgEIHJAAQgFAGgIABQgaAFgbABIgKAAIgXgBgAk2gCIgDgEIAfAAIgIAEIgUAAg");
	...
	this.shape_59.graphics.f("#0B0B0B").s().p("ALuIIIBQB+IAAACQhAgpgQhXgAs5phIgEgeQAsgWApAlIAFAPIgUAAIAAAKIgmABg");
	this.shape_59.setTransform(-8,-7.5);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#FFCC33").s().p("");
	...
	this.shape_67.graphics.f("#171717").s().p("");
