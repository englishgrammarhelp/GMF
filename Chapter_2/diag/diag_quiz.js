...
(lib.practicequiz2 = function(mode,startPosition,loop) {
	...
	this.shape_112.graphics.f().s("#000000").ss(3,1,1).p("AJr1QQBzABByABIUBAIIgbAAQgJAAgKAAQolgColgCMgwpAADIAAAOEghQgUkMAAAAp1MBCaAAAMAAAgqX");
	this.shape_112.setTransform(65.5,267);

	this.shape_113 = new cjs.Shape();
	this.shape_113.graphics.f("#66CCFF").s().p("Egg/AF2IAArrMBB/AAAIAALrg");
	this.shape_113.setTransform(64.9,170.6);

	this.shape_114 = new cjs.Shape();
	this.shape_114.graphics.f("#00CCFF").s().p("EghMAVOMAAAgp1IAAgMIAAgJIAAgOMAwpgADIRKAEIATAAIAUAAMAAAAqXgEghBgU9IAALuMBB/AAAIAAruIAAgCMhB/AAAg");
