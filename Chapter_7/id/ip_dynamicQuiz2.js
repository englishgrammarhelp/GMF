...
lib.ssMetadata = [
		{name:"ip_dynamicQuiz2_atlas_", frames: [[482,1687,182,69],[0,1220,1004,386],[0,614,1042,604],[0,1809,279,77],[482,1608,279,77],[201,1687,279,77],[201,1608,279,77],[275,1986,253,33],[0,1888,273,71],[666,1687,71,71],[281,1766,97,93],[201,1766,56,32],[492,1758,34,37],[281,1861,43,24],[275,1888,96,96],[884,1608,96,96],[485,1819,93,47],[373,1914,110,51],[485,1868,93,47],[380,1766,110,51],[485,1917,93,47],[373,1861,110,51],[530,1758,93,47],[0,0,1042,612],[763,1608,119,115],[0,1608,199,199],[1006,1432,201,201],[1006,1220,210,210],[0,1961,273,71]]}
];
...
(lib.CachedTexturedBitmap_50 = function() {
	this.initialize(ss["ip_dynamicQuiz2_atlas_"]);
	this.gotoAndStop(0);
...
(lib.goNext = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.CachedTexturedBitmap_74();
	this.instance_1.parent = this;
...
(lib.UI = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function openPrev(){
		 ...
		 window.open ("ip_dynamicQuiz1.html","_self");
		}
	}
...
// stage content:
(lib.ip_dynamicQuiz2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.quest1},{t:this.answer1},{t:this.answer2},{t:this.answer3},{t:this.answer4},{t:this.quest2},{t:this.text_1},{t:this.text},{t:this.instance}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/ip_dynamicQuiz2_atlas_.png", id:"ip_dynamicQuiz2_atlas_"},
