...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(88.4,28.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(74.7,25);
	...
	this.shape_2.setTransform(63.8,21.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AglA6QgTgRAAgdQAAgZASgdQAUgfAXAAQANAAAQAGQAUAHAAAMQAAAFgDAEQgDADgFAAQgEAAgDgCIgFgEQgIgHgSAAQgMAAgNAYQgMAWAAAPQAAASAMAKQALAJAQAAQAIAAAJgEIAPgIIAGgCQAFAAADAEQAEAEAAAFQAAAJgUAJQgSAIgMAAQgaAAgSgQg");
	this.shape_3.setTransform(52.9,25.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("");
	this.shape_4.setTransform(39.1,25);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AAqBDIgJgJIgWAKQgJAEgGAAQgfgBgOgRQgNgQAAgiQgBgfAWgXQAXgWAdAAQALAAAPAGQASAHAAAKQAAAEgDADIgCARIgBAcQAAAQACAKQACAGAGARIAEAHIABACQAAAFgEAEQgEADgFAAQgCAAgHgGgAgWggQgPARAAAUQABAWAHALQAIALAQgBQALAAAJgEQAFgDAIgHQgEgiAAgRIAAgNIADgOIgIgEIgGgBQgUAAgPARg");
	this.shape_5.setTransform(24.9,25.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AguBaQgTgTAAgdQAAgjATgVQATgUAcgBQAQABAIAEIAMAKQACg4ADgUQABgLALAAQAMAAAAAMQAAATgGA+QgBATAAAUQAAArAEAXIAAACQAAAGgDADQgEAEgFAAQgIAAgEgMQgJAHgLAEQgKADgKAAQgbAAgSgSgAgeACQgLAOAAAaQAAAQAMANQAMAMAQAAQAKAAAIgEIAOgLIAEgEIAAgXIAAgPIAAgQQgFgKgIgFQgIgFgMAAQgVAAgLAMg");
	this.shape_6.setTransform(9.9,21.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(0,0,97.9,41.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(0,0,19,41.6), null);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQAOAHAAAOQAAAJgLAIQgFADgPAGIgcAMQAEAFAFACQAGACAIAAQALABAIgFQAHgFAFAAQAJABAAAIQAAAKgPAHQgMAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIAUgIIASgKQgHgEgJAAQgHAAgGAGg");
	this.shape.setTransform(26.6,17.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AAVBCQgFgIgJgLIgMgSIgMAIIgBAXQAAAFgEADQgDAEgGAAQgMAAABgPIABgVIABgVIAAgcIAAgdIAAgIIAAgJQgBgGADgDQAEgDAFAAQAGAAADADQAEADAAAGIAAAJIABAJIgBAZIAAAXQALgIAYgZQADgDAGAAQAEAAAFADQADAEAAAFQAAAEgDADQgKALgPANIATAXQAMASAAAGQAAAFgEADQgDADgFAAQgHAAgDgGg");
	this.shape_1.setTransform(17.2,15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgKBAQgEgEABgEIgBgQIAAgRIABgUIABgSQgBgFAEgDQAEgDAEAAQAFAAADADQADADAAAFIAAASIgBAUIAAARIAAAQQABAEgEAEQgEADgEAAQgFAAgDgDgAgIgsQgDgDAAgGQAAgFADgEQAFgEAEAAQAGAAAFAEQADAEABAFQgBAGgDADQgFAEgGAAQgEAAgFgEg");
	this.shape_2.setTransform(9.7,15.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgIBFQgDgEAAgEIAAh5QAAgGADgDQAEgDAEAAQAFAAADADQAEADAAAGIAABzQAAASgMgBQgFABgDgEg");
	this.shape_3.setTransform(4.4,15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(0,0,34,29.1), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgpBAQgDgEAAgEQAAgFAEgEQADgDAFAAIASgCIAAgnQgBgXACgWIgTAAQgFAAgEgDQgDgDAAgFQAAgGADgDQADgDAFAAIAagBQAPAAAbAEQALABAAALQAAAFgFAEQgDACgFAAIgWgCIgBAqIgBAnIAYAAQAGAAADAEQAEADAAAFQAAAFgEADQgEAEgFAAIgPAAIgPAAIgRACIgSABQgFAAgEgDg");
	this.shape.setTransform(6.9,15.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,14,29.1), null);
...
(lib.Directions2 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(103.6,0.7);
	...
	this.shape_1.setTransform(95.6,6.2);
	...
	this.shape_2.setTransform(84.9,3.3);
	...
	this.shape_3.setTransform(76.4,0.9);
	...
	this.shape_4.setTransform(65.3,3.5);
	...
	this.shape_5.setTransform(49,3.5);
	...
	this.shape_6.setTransform(35.3,3.6);
	...
	this.shape_7.setTransform(25.2,3.5);
	...
	this.shape_8.setTransform(14.1,6.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#6600CC").s().p("AAhA1IgHgIIgSAIQgHADgEgBQgYAAgLgNQgKgMAAgbQAAgYARgRQARgSAWAAQAKAAAKAEQAOAHABAIQAAACgCACIgCANIgBAWQAAAMACAIIAGASIADAFIABACQAAAFgEACQgDADgDAAQgCAAgFgEgAgRgZQgLANAAAQQAAARAGAIQAGAIAMAAQAIAAAHgDIALgIQgDgagBgOIABgJIACgLIgGgDIgFgBQgPAAgMANg");
	this.shape_9.setTransform(3.3,3.6);
	...
	this.shape_10.setTransform(-4.8,0.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#6600CC").s().p("AggBTQgLgDgGgFIgBAAQgFAAgDgDQgCgDAAgEIABggIAAghIAAgiIAAgkQAAgFAEgEQAEgFAEAAQADAAAOAHIASAJQAdAKAUAUQAYAYAAAdQAAARgIAQQgJAQgOAKQgPALgdAAQgIAAgKgCgAgmgcIAAAdIgCA4IADABQAJAGAOAAQAWAAALgHQAJgHAGgLQAHgMgBgMQAAgcgfgUQgKgHgmgRg");
	this.shape_11.setTransform(-15.2,1.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#6600CC").s().p("AgiAsQgQgMAAgYQAAgZANgSQAOgUAXAAQAQAAALAGQANAHAAAPQAAAKgLAIIgWALIgmASQAFAJAJAEQAJAEAKAAQAHAAAKgCQAMgEADgFQAEgGAEAAQAEAAACADQADADAAADQAAAMgTAIQgPAHgPAAQgWAAgOgMgAgVgbQgIAKgEASIAfgOQASgJAIgGQgJgIgPAAQgMAAgJAJg");
	this.shape_12.setTransform(-35,3.4);
	...
	this.shape_13.setTransform(-46.3,3.4);
	...
	this.shape_14.setTransform(-54.5,0.9);
	...
	this.shape_15.setTransform(-62.6,1.7);
	...
	this.shape_16.setTransform(-72.9,3.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#6600CC").s().p("AAhA1IgHgIIgSAIQgHADgEgBQgYAAgLgNQgLgMAAgbQAAgYASgRQARgSAWAAQAKAAALAEQAOAHgBAIQAAACgCACIgBANIgBAWQAAAMACAIIAHASIACAFIAAACQAAAFgCACQgEADgDAAQgCAAgFgEgAgQgZQgMANAAAQQAAARAGAIQAGAIAMAAQAIAAAIgDIAKgIQgDgaAAgOIAAgJIACgLIgHgDIgEgBQgPAAgLANg");
	this.shape_17.setTransform(-83.7,3.6);
	...
	this.shape_18.setTransform(-93.8,3.5);
	...
	this.shape_19.setTransform(-104.5,0.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-112.2,-16.6,224.4,33.3);
...
}).prototype = getMCSymbolPrototype(lib.item2, new cjs.Rectangle(0,0,48.6,41.6), null);
...
// stage content:
(lib.ger_Scene5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{scene8a:0});
	...
	this.frame_0 = function() {
		...
		function openNext(){
		 ...
		 window.open ("ger_Scene6.html","_self");
		}
	...
	this.shape.setTransform(359.5,76.6);
	...
	this.shape_1.setTransform(348.7,74);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("");
	this.shape_2.setTransform(335,70.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgMBfQgEgDAAgGIAAgXIgBgYIACgfIABgeQAAgGAEgEQADgDAGAAQAFAAADADQAEAEAAAGIgBAeIgCAfIABAYIAAAXQAAAGgDADQgEAEgFAAQgFAAgEgEgAgIhIQgEgEAAgHQAAgGAEgFQAFgEAFAAQAHAAAEAEQAFAFAAAGQAAAHgFAEQgEAEgHAAQgFAAgFgEg");
	this.shape_3.setTransform(324.1,67.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AglA6QgTgRAAgdQAAgZASgdQAUgfAXAAQANAAAQAGQAUAHAAAMQAAAFgDAEQgDADgFAAQgEAAgDgCIgFgEQgIgHgSAAQgMAAgNAYQgMAWAAAPQAAASAMAKQALAJAQAAQAIAAAJgEIAPgIIAGgCQAFAAADAEQAEAEAAAFQAAAJgUAJQgSAIgMAAQgaAAgSgQg");
	this.shape_4.setTransform(313.2,70.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("");
	this.shape_5.setTransform(299.4,70.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAqBEIgIgKIgXAKQgKAEgFgBQgfAAgOgRQgNgQAAgiQAAgfAVgWQAWgXAeAAQALAAAPAGQASAHAAALQgBADgCADIgCAQIgBAdQAAAQADAKQABAFAGASIAEAHIABACQgBAFgDAEQgEADgEAAQgDAAgHgFgAgWggQgOAQAAAVQAAAWAIALQAHAKAPABQAMgBAJgEQAEgCAJgIQgEgiAAgSIABgLIACgPIgIgEIgGgBQgUAAgPARg");
	this.shape_6.setTransform(285.2,70.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AguBaQgTgSAAgeQAAgjATgVQATgUAcAAQAQgBAIAFIAMAJQACg3ADgUQABgLALAAQAMAAAAAMQAAATgGA+QgBATAAATQAAAtAEAWIAAACQAAAGgDADQgEAEgFAAQgIAAgEgMQgJAHgLADQgKAEgKAAQgbAAgSgSgAgeACQgLANAAAaQAAASAMAMQAMAMAQAAQAKAAAIgEIAOgLIAEgEIAAgXIAAgPIAAgPQgFgLgIgFQgIgFgMAAQgVAAgLAMg");
	this.shape_7.setTransform(270.2,66.8);
	...
	this.shape_8.setTransform(247.2,70.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AAjBlQgHgNgOgTIgWgfIgYARIgBAnQAAAGgEAEQgDAEgGAAQgNAAAAgSIABghIACghIAAgtIABgtIgBgOIAAgOQAAgGADgEQAEgDAGAAQAFAAAEADQAEAEAAAGIAAAOIABAOIgBArQgBAXABAWQASgOAPgPIAdgeQAFgEAFAAQAFAAAEADQAEAEAAAGQAAAEgEAEQgQAUgYAVIAdAmQAUAcAAAIQAAAGgEADQgEAFgGAAQgHAAgEgIg");
	this.shape_9.setTransform(233,66.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AgMBfQgEgDAAgGIAAgXIgBgYIACgfIABgeQAAgGAEgEQADgDAGAAQAFAAADADQAEAEAAAGIgBAeIgCAfIABAYIAAAXQAAAGgDADQgEAEgFAAQgFAAgEgEgAgIhIQgEgEAAgHQAAgGAEgFQAFgEAFAAQAHAAAEAEQAFAFAAAGQAAAHgFAEQgEAEgHAAQgFAAgFgEg");
	this.shape_10.setTransform(221.4,67.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgOBfIABgvIACgwIABgvIAAgwQAAgNAMAAQANAAAAANIAAAwIgBAvIgCBBIgBAfQgBANgLAAQgNAAAAgOg");
	this.shape_11.setTransform(213.7,66.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("");
	this.shape_12.setTransform(194.6,67.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(3,1,1).p("AWckvIj7AAIh9iOAWcAcICMCNIHWAAAfCkvIomAAAWcAcIAAlLAYoCpIkZAAICNiNAr4i+IAAFnIUZAAILuAAAIhjCIAAFrAr4CpI0EAAAr4HBIAAkYAQcnAIonAA");
	this.shape_13.setTransform(268.9,167.2);
	...
	// items
	this.item3 = new lib.Symbol5();
	this.item3.parent = this;
	this.item3.setTransform(311.4,294.6,1,1,0,0,0,49,20.8);

	this.item2 = new lib.item2();
	this.item2.parent = this;
	this.item2.setTransform(231.8,294.6,1,1,0,0,0,24.3,20.8);

	this.item1 = new lib.Symbol4();
	this.item1.parent = this;
	this.item1.setTransform(191.7,294.6,1,1,0,0,0,9.5,20.8);

	this.correct2 = new lib.Symbol3();
	this.correct2.parent = this;
	this.correct2.setTransform(258.8,169.6,1,1,0,0,0,16.9,14.6);
	this.correct2.visible = false;

	this.correct1 = new lib.Symbol2();
	this.correct1.parent = this;
	this.correct1.setTransform(132.2,169.6,1,1,0,0,0,7,14.6);
	this.correct1.visible = false;

	this.correct3 = new lib.Symbol1();
	this.correct3.parent = this;
	this.correct3.setTransform(384.2,117.3,1,1,0,0,0,38.4,21.8);
	this.correct3.visible = false;

	this.target2 = new lib.Target();
	this.target2.parent = this;
	this.target2.setTransform(224.8,153.3,0.665,0.662,0,-0.3,0,-51.1,-25.2);
	this.target2.alpha = 0;

	this.target3 = new lib.Target();
	this.target3.parent = this;
	this.target3.setTransform(350.7,101.9,0.468,0.49,0,-0.5,0,-50.4,-25.1);
	this.target3.alpha = 0;

	this.target1 = new lib.Target();
	this.target1.parent = this;
	this.target1.setTransform(96.3,152.7,0.706,0.691,0,0,0,-50.9,-25.2);
	this.target1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.target1},{t:this.target3},{t:this.target2},{t:this.correct3},{t:this.correct1},{t:this.correct2},{t:this.item1},{t:this.item2},{t:this.item3}]}).wait(1));
	...
	this.shape_14.setTransform(53.3,10.4);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("");
	this.shape_15.setTransform(45.5,10.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AAMAdQgIADgHAAQgIAAgGgEQgGgEgBgHQgDgPAAgKQAAgIACgKQABgGAHAAQADAAADACQACACAAADIgBAIIAAAIIAAAOIACAKIADABIACAAQAGAAAIgCIAAgKIgBgJIABgUQABgHAHAAQAEAAACACQADACAAADIgBAVIAAALIAAAMIAAADIAAAEQAAADgCACQgDACgDAAQgFAAgCgEg");
	this.shape_16.setTransform(37.6,10.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgFAuQgCgCAAgEIAAhQQAAgDACgCQACgCADAAQAEAAACACQACACAAADIAABNQAAALgIAAQgDAAgCgCg");
	this.shape_17.setTransform(32.8,8.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AgSAZQgJgIAAgOQgBgMAIgKQAJgMAPAAQALAAAHAJQAGAJAAAMQAAANgHAJQgIALgNAAQgKAAgIgHgAgHgJQgEAGAAAGQAAAHAEAEQADADAEAAQAEAAAEgEQAEgEABgHQABgRgLgBQgGAAgEAHg");
	this.shape_18.setTransform(28,10.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AgMAqQgHgRgJgfIgEgQQgEgLAAgFQAAgDADgCQACgCADAAQAGAAACAFIACALIAHATIAIAcIANgiIAFgOQADgJAFgEQACgDADAAQAEAAACACQADACAAAEQAAAAAAABQAAABAAAAQgBABAAAAQAAABgBAAIgFALIgFAMIgQAoIgGAOQgDAEgDAAQgGAAgDgFg");
	this.shape_19.setTransform(21,9.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_goBack},{t:this.instance_1},{t:this.vol_dwn},{t:this.vol_up},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.btn_menu},{t:this.congrats},{t:this.btn_goNext}]}).wait(1));
...
// library properties:
lib.properties = {
	id: '3BE626C451CE3C45AFEBFEFD27E9247E',
	width: 550,
	height: 400,
	fps: 12,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"sounds/bgmusic.mp3?1501200856451", id:"bgmusic"},
		{src:"sounds/wrong.mp3?1501200856451", id:"wrong"},
		{src:"sounds/_3a.mp3?1501200856451", id:"_3a"},
		{src:"sounds/_4b.mp3?1501200856451", id:"_4b"},
		{src:"sounds/wrong_answer.mp3?1501200856451", id:"wrong_answer"},
		{src:"sounds/right.mp3?1501200856451", id:"right"},
		{src:"sounds/_7a.mp3?1501200856451", id:"_7a"},
		{src:"sounds/High_Screaming_Gtr.mp3?1501200856451", id:"High_Screaming_Gtr"},
		{src:"sounds/highclick.mp3?1501200856451", id:"highclick"},
		{src:"sounds/_6a.mp3?1501200856451", id:"_6a"},
		{src:"sounds/lowclick.mp3?1501200856451", id:"lowclick"},
		{src:"sounds/parrotmove1.mp3?1501200856451", id:"parrotmove1"},
		{src:"sounds/parrotmove2.mp3?1501200856451", id:"parrotmove2"},
		{src:"sounds/SENameOfPerson.mp3?1501200856451", id:"SENameOfPerson"},
		{src:"sounds/_6b.mp3?1501200856451", id:"_6b"},
		{src:"sounds/_10a.mp3?1501200856451", id:"_10a"},
		{src:"sounds/_2a.mp3?1501200856451", id:"_2a"}
	],
	preloads: []
};
...
an.compositions['3BE626C451CE3C45AFEBFEFD27E9247E'] = {
