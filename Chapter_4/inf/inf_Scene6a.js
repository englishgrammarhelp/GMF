...
(lib.served = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape.setTransform(58.9,16.5);
	...
	this.shape_1.setTransform(47.8,19.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgKAtIgPgoIgRgsIgBgEQAAgEADgDQADgDAEABQAGAAACAFIAZBDIASgsIAIgWQADgGAFAAQAEAAADADQADADAAAEQAAADgQAnIgUAtQAAAIgIABQgHAAgDgJg");
	this.shape_2.setTransform(37.3,19.1);
	...
	this.shape_3.setTransform(27.9,19.2);
	...
	this.shape_4.setTransform(17.5,19.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("");
	this.shape_5.setTransform(6.7,18.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.served, new cjs.Rectangle(0,0,66.9,31.9), null);


(lib.serve = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AghAqQgPgMAAgWQAAgYANgSQANgSAWAAQAQAAAKAFQAMAHAAAOQAAAKgLAIIgUAKIglARQAGAIAIAEQAIAFAKAAQAHAAAJgDQALgDAEgFQADgGAEAAQADAAADADQADADAAADQAAALgSAIQgPAGgOAAQgVAAgOgLgAgUgZQgHAJgEARIAegNQAQgJAIgGQgJgIgOAAQgMAAgIAKg");
	this.shape.setTransform(47.8,19.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgKAtIgPgoIgRgsIgBgEQAAgEADgDQADgDAEABQAGAAACAFIAZBDIASgsIAIgWQADgGAFAAQAEAAADADQADADAAAEQAAADgQAnIgUAtQAAAIgIABQgHAAgDgJg");
	this.shape_1.setTransform(37.3,19.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AglAtIAAhEIABgJIAAgKQAAgKAIAAQAJAAABAQQASgSAWAAQAJAAADAGQAEAGAAAMIAAAHQAAAMgKAAQgIAAAAgJIgBgHIAAgIQgPABgJAHQgIAHgGAMIABA1QgBAKgJAAQgJAAAAgKg");
	this.shape_2.setTransform(27.9,19.2);
	...
	this.shape_3.setTransform(17.5,19.2);
	...
	this.shape_4.setTransform(6.7,18.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.serve, new cjs.Rectangle(0,0,55.2,31.9), null);
...
(lib.line = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AghAqQgPgMAAgWQAAgYANgSQANgSAWAAQAQAAAKAFQAMAHAAAOQAAAKgLAIIgUAKIglARQAGAIAIAEQAIAFAKAAQAHAAAJgDQALgDAEgFQADgGAEAAQADAAADADQADADAAADQAAALgSAIQgPAGgOAAQgVAAgOgLgAgUgZQgHAJgEARIAegNQAQgJAIgGQgJgIgOAAQgMAAgIAKg");
	this.shape.setTransform(29.2,19.2);
	...
	this.shape_1.setTransform(18.6,19.1);
...
}).prototype = getMCSymbolPrototype(lib.line, new cjs.Rectangle(0,0,36.7,31.9), null);
...
(lib.ball = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(19,19.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	this.shape_3.setTransform(8.2,16.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.ball, new cjs.Rectangle(0,0,37.3,31.9), null);
...
(lib.back = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAZBGQgFgJgKgNIgPgWIgQAMIgBAcQAAAEgDACQgDADgDAAQgKAAAAgNIABgWIABgXIABgfIAAggIAAgKIgBgKQAAgEACgCQADgDAEAAQAEAAADADQACACAAAEIABALIAAAJIAAAeIgBAfQAMgJALgLIAVgVQADgDADAAQADAAADADQADADABAEQgBADgDADQgLANgQAOIAUAbQAOAUAAAGQAAADgDADQgDADgDAAQgFAAgDgGg");
	this.shape.setTransform(38.1,15.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgZApQgOgMAAgUQAAgSANgTQAOgXAQAAQAJAAALAFQAOAFAAAHQAAAEgCADQgCADgEgBQAAAAgBAAQgBAAAAAAQgBAAAAAAQgBgBAAAAIgEgDQgGgEgMgBQgIAAgKARQgIAQAAAKQAAAMAIAHQAIAGALABQAGAAAGgDIALgGIAEgBQADgBACADQADADAAAEQAAAGgOAGQgNAGgIAAQgSAAgMgLg");
	this.shape_1.setTransform(27.6,18.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("");
	this.shape_2.setTransform(17.9,18.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	this.shape_3.setTransform(7.8,15.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.back, new cjs.Rectangle(0,0,44.6,30.1), null);
...
(lib.SentenceLineSlant = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(3,1,1).p("Ah5iyIDzFl");
	this.shape.setTransform(235.6,16.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(3,1,1).p("EAgHAAAMgwqAAAIvjAA");
	this.shape_1.setTransform(205.5,34.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(3,1,1).p("AAAESIAAjvIAAk0");
	this.shape_2.setTransform(99.6,31.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.SentenceLineSlant, new cjs.Rectangle(-1.5,-2.5,414,62.8), null);
...
(lib.Ball = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(21.2,19.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(21,19.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Ball, new cjs.Rectangle(0.1,0.3,41.7,38.4), null);


(lib.prepDia = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape.setTransform(188.3,26.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0033FF").s().p("AAWAuQgMAHgPAAQgNAAgIgGQgKgGgBgMQgEgaAAgTQAAgNADgRQABgJAIAAQAEAAADACQADAEAAAEIgBAOIgCAPIABAbQABAMACAGIAHADIAGABQAMAAAPgEIgBgUIAAgSQAAgVACgPQABgKAJABQAEgBADADQACADAAAEIgBAlIAAAUIAAAVIAAAGIAAAHQAAAEgCADQgDADgEAAQgIAAgCgKg");
	this.shape_1.setTransform(177.7,26.6);
	...
	this.shape_2.setTransform(167.1,26.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#0033FF").s().p("AAYAwIgCgWIgCgVIABgJIAAgJQAAgVgIAAQgLAAgJANQgJAMgFARIgBAKIAAAJIAAAJIABAJQgBAEgCADQgDACgEAAQgEAAgDgCQgDgDABgEIgBgJIgBgJIACgbIABgcIgBgJIAAgJQABgFACgCQADgDAEAAQAJAAABANIAAALQAQgWARAAQAQAAAFAOQAFAJAAASIAAAKIAAAIQAAAIACANQACANAAAIQAAAEgDADQgCADgFAAQgIAAgBgJg");
	this.shape_3.setTransform(157.1,26.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0033FF").ss(2,1,1).p("ABOgWQhFg8hWB8IA6AAAhKgdIgDBH");
	this.shape_4.setTransform(141.7,23);
...
p.nominalBounds = new cjs.Rectangle(-1.5,-1.5,196.9,95.6);
...
(lib.Mick_1 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(17).call(this.frame_17).wait(83));

	// Layer 5
	this.instance = new lib.DoogArmRt("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(12.3,-11.5,1,1,0,0,0,20.2,-5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({regY:-5.1,rotation:67.5,x:10.6,y:-20.5},5).to({rotation:-22.5,x:-0.5,y:-73.1},4).to({regY:-5,scaleX:1.19,scaleY:1.19,rotation:-112.5,x:-9,y:-95.5},2).to({rotation:-142.5,x:-51.5,y:-67.4},3).to({regY:-5.1,rotation:-67.5,x:-71.3,y:-24.2},4).wait(41).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(25));

	// Ball
	this.instance_1 = new lib.Ball();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-27.1,-8.4,0.425,0.425,0,0,0,21.2,19.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(7).to({x:-26.6,y:-17.4},0).to({scaleX:0.64,scaleY:0.64,x:-52.5,y:-145.4},10).to({scaleX:2.07,scaleY:2.07,guide:{path:[-52.5,-145.4,-53.4,-140.2,-54.4,-135.1,-121.3,-153.6,-152,-159.9,-182.8,-166.3,-260.5,-181.7,-337.1,-196.9,-508.5,-184]}},13).to({_off:true},1).wait(69));

	// Layer 1
	this.instance_2 = new lib.DoogBod();
	this.instance_2.parent = this;
	this.instance_2.setTransform(4.7,-8.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10).to({mode:"synched",startPosition:0},0).to({x:-8.1,y:-70.2,startPosition:5},5).to({scaleX:1.19,scaleY:1.19,x:-17.2,y:-91.9,startPosition:7},2).to({x:-59.6,y:-63.9,startPosition:10},3).to({x:-79.6,y:-20.7,mode:"single",startPosition:0},4).wait(41).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(25));

	// Layer 4
	this.instance_3 = new lib.MickArmL("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-13.4,-13.5,0.827,0.827,0,0,0,7.6,15.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10).to({startPosition:0},0).to({regX:7.7,regY:15.7,rotation:75,x:-22.2,y:-75.1},5).to({regY:15.6,scaleX:0.99,scaleY:0.99,rotation:15,x:-33.9,y:-97.9},2).to({rotation:-105,x:-79.9,y:-65.9},3).to({rotation:-135,x:-99.1,y:-18.7},4).wait(41).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(25));

	// Layer 3
	this.instance_4 = new lib.MickLegR("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(13.4,19,1,1,0,0,0,-9.8,-17.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10).to({startPosition:0},0).to({rotation:-15,x:0.6,y:-42.6},5).to({regY:-17.9,scaleX:1.19,scaleY:1.19,rotation:-75,x:-6.8,y:-59.1},2).to({regY:-17.8,rotation:0,x:-49.1,y:-31},3).to({rotation:15,x:-69.1,y:12.2},4).wait(41).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(25));

	// Layer 2
	this.instance_5 = new lib.MickLegL("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-0.2,17.6,1,1,0,0,0,7.4,-20.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(10).to({startPosition:0},0).to({rotation:30,x:-12.9,y:-44},5).to({scaleX:1.19,scaleY:1.19,rotation:-45,x:-23,y:-60.7},2).to({rotation:0,x:-65.3,y:-32.7},3).to({rotation:-15,x:-82.9,y:10.5},4).wait(41).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(25));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-36,-46.1,79.3,108.9);
...
(lib.InfinitivesVprepositions = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(22).call(this.frame_22).wait(12).call(this.frame_34).wait(12).call(this.frame_46).wait(19).call(this.frame_65).wait(29).call(this.frame_94).wait(21).call(this.frame_115).wait(8).call(this.frame_123).wait(10).call(this.frame_133).wait(40).call(this.frame_173).wait(7).call(this.frame_180).wait(17).call(this.frame_197).wait(12).call(this.frame_209).wait(8).call(this.frame_217).wait(49).call(this.frame_266).wait(21).call(this.frame_287).wait(15).call(this.frame_302).wait(39).call(this.frame_341).wait(7).call(this.frame_348).wait(17).call(this.frame_365).wait(17).call(this.frame_382).wait(34).call(this.frame_416).wait(8).call(this.frame_424).wait(6).call(this.frame_430).wait(55).call(this.frame_485).wait(7).call(this.frame_492).wait(7).call(this.frame_499).wait(18).call(this.frame_517).wait(6).call(this.frame_523).wait(14).call(this.frame_537).wait(3).call(this.frame_540).wait(16).call(this.frame_556).wait(63));

	// 1
	this.instance = new lib.to();
	this.instance.parent = this;
	this.instance.setTransform(163.3,236.1,0.806,0.806,0,0,0,14.5,19.4);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(445).to({_off:false},0).to({x:161.7,alpha:1},5).wait(73).to({x:163.3},0).to({x:99.1,y:156.4},17).to({rotation:45,x:163.8,y:114.5},16).wait(63));

	// 2
	this.instance_1 = new lib.the();
	this.instance_1.parent = this;
	this.instance_1.setTransform(194.6,236.1,0.942,0.942,0,0,0,18.1,16);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(445).to({_off:false},0).to({x:192.2,alpha:1},5).wait(73).to({x:194.6},0).to({x:255.8,y:211.1},17).to({regX:18,rotation:45,x:223.7,y:162},16).wait(63));

	// 3
	this.instance_2 = new lib.Tocaps();
	this.instance_2.parent = this;
	this.instance_2.setTransform(105.4,38.4,0.772,0.772,0,0,0,17.1,19.4);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.instance_3 = new lib.back();
	this.instance_3.parent = this;
	this.instance_3.setTransform(238.1,236,1,1,0,0,0,22.3,15);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(252).to({_off:false},0).to({x:111,alpha:1},5).wait(30).to({rotation:45,x:21.7,y:75.6},15).wait(33).to({alpha:0},5).to({_off:true},1).wait(278));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(445).to({_off:false},0).to({x:233.7,alpha:1},5).wait(73).to({x:238.1},0).to({x:323.1,y:205},17).to({rotation:45,x:267.6,y:158.2},16).wait(63));

	// 4
	this.instance_4 = new lib.serve();
	this.instance_4.parent = this;
	this.instance_4.setTransform(160.5,41.7,0.94,0.941,0,0,0,35.6,19.4);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.instance_5 = new lib.line();
	this.instance_5.parent = this;
	this.instance_5.setTransform(281,236.1,0.942,0.942,0,0,0,18.3,16);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(252).to({_off:false},0).to({scaleX:0.97,scaleY:0.97,x:161.6,alpha:1},5).wait(30).to({scaleX:0.94,scaleY:0.94,x:160.5},0).to({x:70.4,y:87},15).wait(33).to({alpha:0},5).to({_off:true},1).wait(278));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(445).to({_off:false},0).to({x:275.4,alpha:1},5).wait(73).to({x:281},0).to({x:236.7,y:110.3},17).to({x:205.8,y:120.3},16).wait(63));

	// 5
	this.instance_6 = new lib.Mick();
	this.instance_6.parent = this;
	this.instance_6.setTransform(133,44.9,0.829,0.829,0,0,0,36.4,19.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.Tocaps();
	this.instance_7.parent = this;
	this.instance_7.setTransform(116.7,43.9,0.811,0.811,0,0,0,17.1,19.4);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.is();
	this.instance_8.parent = this;
	this.instance_8.setTransform(194.9,38.5,0.772,0.772,0,0,0,11.7,19.4);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(83).to({_off:false},0).to({x:132.6,alpha:1},4).wait(28).to({x:133},0).to({x:48.2,y:55.9},8).to({x:74.7,y:122.6},10).wait(19).to({alpha:0},5).to({_off:true},1).wait(287).to({_off:false,regX:24.3,regY:16,scaleX:0.94,scaleY:0.94,x:-18.5,y:236.1},0).to({x:-12.5,alpha:1},5).wait(67).to({x:-18.5},0).to({x:29.8,y:73.2},20).to({x:63.6,y:86},19).wait(63));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(163).to({_off:false},0).to({alpha:1},4).wait(30).to({x:14.7,y:52.8},12).to({rotation:45,x:21.4,y:72.5},8).wait(18).to({alpha:0},5).to({_off:true},1).wait(378));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(252).to({_off:false},0).to({scaleX:0.8,scaleY:0.8,x:193.8,y:38.3,alpha:1},5).wait(32).to({scaleX:0.77,scaleY:0.77,x:191.7,y:38.5},0).to({x:162.6,y:119.5},13).wait(33).to({x:163.4,alpha:0},5).to({_off:true},1).wait(278));

	// 6
	this.instance_9 = new lib.loves();
	this.instance_9.parent = this;
	this.instance_9.setTransform(168.8,41.6,0.692,0.692,0,0,0,31.1,19.4);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.instance_10 = new lib.serve();
	this.instance_10.parent = this;
	this.instance_10.setTransform(171.4,47.2,1.071,1.071,0,0,0,35.6,19.4);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.instance_11 = new lib.to();
	this.instance_11.parent = this;
	this.instance_11.setTransform(217.3,38.5,0.773,0.772,0,0,0,14.5,19.4);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.instance_12 = new lib.served();
	this.instance_12.parent = this;
	this.instance_12.setTransform(38.2,236.1,0.942,0.942,0,0,0,33.5,16);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(83).to({_off:false},0).to({x:166,alpha:1},4).wait(28).to({x:168.8},0).to({y:58.5},8).to({x:170.8,y:120.4},10).wait(19).to({alpha:0},5).to({_off:true},1).wait(461));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(163).to({_off:false},0).to({scaleX:1.01,scaleY:1.01,x:168.2,y:47.6,alpha:1},4).wait(30).to({scaleX:1.07,scaleY:1.07,x:171.4,y:47.2},0).to({x:82,y:60.2},12).to({x:68.8,y:88},8).wait(18).to({alpha:0},5).to({_off:true},1).wait(378));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(252).to({_off:false},0).to({alpha:1},5).wait(30).to({regY:19.5,rotation:45,x:270.4,y:75.4},15).wait(33).to({alpha:0},5).to({_off:true},1).wait(278));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(445).to({_off:false},0).to({x:44.2,alpha:1},5).wait(67).to({x:38.2},0).to({x:162.3,y:58.2},20).to({x:176,y:86},19).wait(63));

	// 7
	this.instance_13 = new lib.to();
	this.instance_13.parent = this;
	this.instance_13.setTransform(204.3,41.6,0.692,0.692,0,0,0,14.6,19.4);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.instance_14 = new lib.is();
	this.instance_14.parent = this;
	this.instance_14.setTransform(205,43.9,0.811,0.811,0,0,0,11.7,19.4);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.instance_15 = new lib.win();
	this.instance_15.parent = this;
	this.instance_15.setTransform(250.2,38.5,0.94,0.941,0,0,0,16.9,16);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;
	new cjs.ButtonHelper(this.instance_15, 0, 1, 1);

	this.instance_16 = new lib.the();
	this.instance_16.parent = this;
	this.instance_16.setTransform(89.6,236.1,0.942,0.942,0,0,0,18.1,16);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(83).to({_off:false},0).to({x:199.9,alpha:1},4).wait(28).to({x:204.3},0).to({x:258,y:58.5},8).to({regX:14.5,rotation:45,x:261.1,y:75.9},10).wait(19).to({alpha:0},5).to({_off:true},1).wait(461));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(163).to({_off:false},0).to({x:199,y:44.3,alpha:1},4).wait(30).to({x:205,y:43.9},0).to({x:178.1,y:76.7},12).to({x:175.1,y:117.1},8).wait(18).to({alpha:0},5).to({_off:true},1).wait(378));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(252).to({_off:false},0).to({regY:15.8,scaleX:0.98,scaleY:0.98,x:247.8,y:38.4,alpha:1},5).wait(30).to({regY:16,scaleX:0.94,scaleY:0.94,x:250.2,y:38.5},0).to({x:316.3,y:83.8},15).wait(33).to({alpha:0},5).to({_off:true},1).wait(278));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(445).to({_off:false},0).to({x:94,alpha:1},5).wait(67).to({x:89.6},0).to({x:318.5,y:134.1},20).to({regX:18,regY:15.9,rotation:45,x:332,y:116},19).wait(63));

	// slash2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("Ag7hAIB2CB");
	this.shape.setTransform(183.5,142.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(2.2,1,1).p("AhYhdICxC7");
	this.shape_1.setTransform(186.2,145.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(2.3,1,1).p("Ah2h6IDtD1");
	this.shape_2.setTransform(188.9,148.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(2.4,1,1).p("AiTiXIEnEv");
	this.shape_3.setTransform(191.7,151.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(2.5,1,1).p("Aixi0IFjFp");
	this.shape_4.setTransform(194.4,154.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(2.7,1,1).p("AjPjRIGfGj");
	this.shape_5.setTransform(197.1,157);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(2.8,1,1).p("AjsjuIHZHd");
	this.shape_6.setTransform(199.8,159.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(2.9,1,1).p("AkKkLIIVIX");
	this.shape_7.setTransform(202.5,162.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(3,1,1).p("AknkoIJPJR");
	this.shape_8.setTransform(205.2,165.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},499).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).wait(112));

	// slash1
	this.instance_17 = new lib.serve();
	this.instance_17.parent = this;
	this.instance_17.setTransform(249.6,44.7,0.915,0.915,0,0,0,35.6,19.4);
	this.instance_17.alpha = 0;
	this.instance_17._off = true;

	this.instance_18 = new lib.hard();
	this.instance_18.parent = this;
	this.instance_18.setTransform(242.8,43.9,0.811,0.811,0,0,0,29.1,19.4);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.instance_19 = new lib.ball();
	this.instance_19.parent = this;
	this.instance_19.setTransform(130.3,236.1,0.942,0.942,0,0,0,18.7,16);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(83).to({_off:false},0).to({regX:35.7,scaleX:0.85,scaleY:0.85,x:242.1,alpha:1},4).wait(28).to({regX:35.6,scaleX:0.92,scaleY:0.92,x:249.6},0).to({x:318.3,y:64.2},8).to({x:310.3,y:87.6},10).wait(19).to({alpha:0},5).to({_off:true},1).wait(461));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(163).to({_off:false},0).to({x:234.4,y:44.3,alpha:1},4).wait(30).to({x:242.8,y:43.9},0).to({x:305.5,y:76.7},12).to({y:117.1},8).wait(18).to({alpha:0},5).to({_off:true},1).wait(378));
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(445).to({_off:false},0).to({x:131.1,alpha:1},5).wait(67).to({x:130.3},0).to({x:281.3,y:53.9},20).to({x:300.5,y:86},19).wait(63));

	// slash3
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("AgiglIBFBL");
	this.shape_9.setTransform(304.6,104.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(2,1,1).p("AhChEICFCJ");
	this.shape_10.setTransform(307.6,107.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(2,1,1).p("AhhhjIDDDH");
	this.shape_11.setTransform(310.6,110.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("AiBiCIEDEF");
	this.shape_12.setTransform(313.7,113.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(2,1,1).p("AihiiIFCFF");
	this.shape_13.setTransform(316.7,117);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(2,1,1).p("AjAjBIGBGD");
	this.shape_14.setTransform(319.7,120.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(2,1,1).p("AjgjgIHBHB");
	this.shape_15.setTransform(322.7,123.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(2,1,1).p("Aj/j/IH/IA");
	this.shape_16.setTransform(325.8,126.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_9}]},492).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).wait(120));

	// Sentence
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("rgba(0,0,0,0.506)").s().p("AgGAHQgDgDAAgEQAAgDADgDQADgDADAAQAEAAADADQADADAAADQAAAEgDADQgDADgEAAQgDAAgDgDg");
	this.shape_17.setTransform(258.7,48.4);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("rgba(0,0,0,0.506)").s().p("AgbAkQgOgLAAgSQAAgVALgPQAMgPASAAQANAAAJAEQALAGAAAMQAAAIgJAHIgSAIIgfAPQAFAHAGAEQAIADAIAAQAFAAAJgCQAJgDADgEQADgFADAAQADAAACADQADACAAADQAAAJgQAGQgMAGgMAAQgSAAgLgJgAgRgWQgGAIgDAPIAZgLQAOgIAGgFQgGgHgNAAQgJAAgIAIg");
	this.shape_18.setTransform(252.1,44.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("rgba(0,0,0,0.506)").s().p("AgIAmIgNghIgPglIgBgFQAAgDADgCQADgDADAAQAFABACAFIAVA4IAPglIAHgTQACgFAFAAQAEAAACACQADADAAADQAAADgOAgIgRAnQAAAHgHAAQgGABgCgIg");
	this.shape_19.setTransform(243.2,44.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("rgba(0,0,0,0.506)").s().p("AgfAmIAAg5IAAgJIAAgIQAAgIAIAAQAIAAAAAOQAPgQATAAQAHABADAFQADAEAAALIAAAFQAAALgIAAQgHAAAAgIIAAgGIgBgHQgNABgHAHQgHAFgFALIAAAsQAAAJgIAAQgHAAAAgJg");
	this.shape_20.setTransform(235.2,44.6);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("rgba(0,0,0,0.506)").s().p("AgcAkQgNgLABgSQAAgVAKgPQALgPATAAQAOAAAIAEQALAGAAAMQAAAIgKAHIgRAIIgfAPQAEAHAIAEQAHADAIAAQAGAAAHgCQAKgDADgEQADgFADAAQADAAACADQADACgBADQABAJgQAGQgMAGgMAAQgSAAgMgJgAgQgWQgHAIgEAPIAagLQAOgIAHgFQgIgHgMAAQgJAAgHAIg");
	this.shape_21.setTransform(226.4,44.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_22.setTransform(217.2,44.2);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("rgba(0,0,0,0.506)").s().p("AgYAjQgLgLgBgTQAAgTAKgNQALgRAUgBQARABAIAPQAHAMAAARQgBARgJANQgLAQgQgBQgOAAgKgKgAgOgQQgGAJAAAMQAAALAHAHQAGAGAHgBQAIAAAGgFQAHgIAAgMQABgegSAAIgBgBQgLAAgGAMg");
	this.shape_23.setTransform(203.5,44.6);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("rgba(0,0,0,0.506)").s().p("AgEA6QgDgCAAgDIAAgJIABgKIgCgvIgSgCQgIgBAAgHQAAgEACgCQADgCADAAIASABIgBgLIAAgLQAAgDACgCQADgDADAAQAHAAABAMIAAAIIAAAFIAAAFIAMgBIALAAQAFACAAAGQAAAEgCACQgDADgDAAIgEgBIgEAAIgMABIACAwIAAAEIAAAEQAAATgJAAQgCAAgCgDg");
	this.shape_24.setTransform(195.2,43.1);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_25.setTransform(181.7,44.2);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("rgba(0,0,0,0.506)").s().p("AgbAkQgOgLAAgSQAAgVALgPQAMgPASAAQANAAAJAEQALAGAAAMQAAAIgJAHIgSAIIgfAPQAFAHAGAEQAIADAIAAQAFAAAJgCQAJgDADgEQADgFADAAQADAAACADQADACAAADQAAAJgQAGQgMAGgMAAQgSAAgLgJgAgRgWQgGAIgDAPIAZgLQAOgIAGgFQgGgHgNAAQgJAAgIAIg");
	this.shape_26.setTransform(173.3,44.5);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("rgba(0,0,0,0.506)").s().p("AgIAmIgNghIgPglIgBgFQAAgDADgCQADgDADAAQAFABACAFIAVA4IAPglIAHgTQACgFAFAAQAEAAACACQADADAAADQAAADgOAgIgRAnQAAAHgHAAQgGABgCgIg");
	this.shape_27.setTransform(164.5,44.5);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("rgba(0,0,0,0.506)").s().p("AgYAjQgLgLgBgTQAAgTAKgNQALgRAUgBQARABAIAPQAHAMAAARQgBARgJANQgLAQgQgBQgOAAgKgKgAgOgQQgGAJAAAMQAAALAHAHQAGAGAHgBQAIAAAGgFQAHgIAAgMQABgegSAAIgBgBQgLAAgGAMg");
	this.shape_28.setTransform(155.6,44.6);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("rgba(0,0,0,0.506)").s().p("AgIA8IAAgeIABgeIAAgdIABgfQAAgHAHgBQAIABAAAHIAAAfIgBAdIAAApIgBAUQgBAHgGAAQgJABABgJg");
	this.shape_29.setTransform(149,42.2);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("rgba(0,0,0,0.506)").s().p("AAWA/QgEgIgJgLIgOgVIgPALIgBAZQAAAEgCACQgCADgEAAQgIAAAAgMIABgUIABgVIABgcIAAgcIAAgJIgBgJQAAgEACgCQADgCADAAQADAAADACQACACAAAEIABAJIAAAJIAAAbIgBAcIAVgSIASgTQADgDADAAQADAAADADQADACAAAEQAAACgDADQgKAMgPANIASAYQANASAAAFQAAADgDADQgCACgEAAQgEAAgDgFg");
	this.shape_30.setTransform(137.5,42.2);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("rgba(0,0,0,0.506)").s().p("AgXAkQgMgKAAgSQAAgQAMgSQAMgTAOAAQAIgBAKAEQAOAFAAAHQgBADgCACQgCADgDAAQgBAAAAAAQgBAAAAAAQgBgBAAAAQgBAAAAgBIgDgCQgFgEgMAAQgHAAgJAPQgHAOAAAJQAAALAHAGQAIAGAJAAQAFAAAGgDIAKgEIAEgCQACAAACADQADACAAADQAAAGgNAGQgLAEgIAAQgQABgLgLg");
	this.shape_31.setTransform(128,44.5);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("rgba(0,0,0,0.506)").s().p("AgHA8QgCgCgBgEIAAgOIAAgPIAAgUIABgSQAAgFADgBQACgDADAAQADAAADADQACABAAAFIgBASIgBAUIAAAPIAAAOQAAAEgBACQgDADgDgBQgDABgCgDgAgEgtQgDgDgBgEQABgDADgDQACgEAEAAQADAAADAEQADADAAADQAAAEgDADQgDADgDAAQgEAAgCgDg");
	this.shape_32.setTransform(121.4,42.5);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_33.setTransform(111.5,42.6);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("rgba(0,0,0,0.506)").s().p("AgIAIQgDgDAAgFQAAgEADgEQAEgDAEAAQAFAAADADQAEAEAAAEQAAAFgEADQgDAEgFAAQgEAAgEgEg");
	this.shape_34.setTransform(258.6,51.9);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("rgba(0,0,0,0.506)").s().p("AgiBCQgOgOAAgVQAAgaAOgPQAOgPAVAAQALgBAGAEIAKAHIADg3QABgJAIAAQAJAAAAAKQAAANgEAuIgBAcQAAAhADAQIAAACQAAAEgDADQgDACgDAAQgGAAgDgJQgHAGgIACQgHADgIAAQgUAAgNgOgAgWACQgIAJAAAUQAAAMAJAJQAIAJAMAAQAIAAAFgDQAEgBAHgHIADgCIAAgRIAAgMIAAgMQgEgHgGgDQgGgEgJAAQgPAAgIAJg");
	this.shape_35.setTransform(250.1,44.7);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("rgba(0,0,0,0.506)").s().p("AglAtIAAhEIABgJIAAgKQAAgKAIAAQAJAAABAQQASgSAWAAQAJAAADAGQAEAGAAAMIAAAHQAAAMgKAAQgIAAAAgJIgBgHIAAgIQgPABgJAHQgIAHgGAMIABA1QgBAKgJAAQgJAAAAgKg");
	this.shape_36.setTransform(239.8,47.4);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("rgba(0,0,0,0.506)").s().p("AAfAyIgHgHIgQAHQgHADgEAAQgWAAgLgNQgKgMAAgZQAAgXAQgQQAQgRAWAAQAJAAAKAEQANAGAAAHQAAADgBACIgCAMIAAAVQgBAMACAHIAGARIADAGIAAABQAAAEgDADQgCACgEAAQgCAAgFgEgAgPgYQgMANAAAPQAAAQAGAIQAFAIAMAAQAIAAAHgDIAKgIQgDgZAAgNIAAgJIACgKIgHgDIgDgBQgPAAgKAMg");
	this.shape_37.setTransform(229.6,47.4);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_38.setTransform(218.8,44.7);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_39.setTransform(201.8,46.9);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("rgba(0,0,0,0.506)").s().p("AgJBHQgCgDAAgFIAAgRIgBgRIABgXIABgWQAAgEACgDQADgDAEAAQAEAAADADQACADAAAEIgBAWIgBAXIABARIAAARQAAAFgDADQgCADgEAAQgEAAgDgDgAgGg1QgDgEAAgEQAAgFADgDQAEgDADgBQAGABADADQADADAAAFQAAAEgDAEQgDADgGABQgDgBgEgDg");
	this.shape_40.setTransform(194.6,44.9);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("rgba(0,0,0,0.506)").s().p("AghAqQgPgMAAgWQAAgYANgSQANgSAWAAQAQAAAKAFQAMAHAAAOQAAAKgLAIIgUAKIglARQAGAIAIAEQAIAFAKAAQAHAAAJgDQALgDAEgFQADgGAEAAQADAAADADQADADAAADQAAALgSAIQgPAGgOAAQgVAAgOgLgAgUgZQgHAJgEARIAegNQAQgJAIgGQgJgIgOAAQgMAAgIAKg");
	this.shape_41.setTransform(180.3,47.3);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("rgba(0,0,0,0.506)").s().p("AgKAtIgPgoIgRgsIgBgEQAAgEADgDQADgCAEAAQAGAAACAFIAZBEIASgsIAIgXQADgGAFAAQAEAAADADQADADAAAEQAAADgQAmIgUAtQAAAJgIAAQgHABgDgJg");
	this.shape_42.setTransform(169.8,47.3);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("rgba(0,0,0,0.506)").s().p("AglAtIAAhEIAAgJIAAgKQABgKAIAAQAKAAAAAQQASgSAXAAQAHAAAEAGQAEAGAAAMIAAAHQAAAMgKAAQgIAAAAgJIgBgHIAAgIQgPABgIAHQgJAHgGAMIAAA1QABAKgKAAQgJAAAAgKg");
	this.shape_43.setTransform(160.4,47.4);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("rgba(0,0,0,0.506)").s().p("AghAqQgPgMAAgWQAAgYANgSQANgSAWAAQAQAAAKAFQAMAHAAAOQAAAKgLAIIgUAKIglARQAGAIAIAEQAIAFAKAAQAHAAAJgDQALgDAEgFQADgGAEAAQADAAADADQADADAAADQAAALgSAIQgPAGgOAAQgVAAgOgLgAgUgZQgHAJgEARIAegNQAQgJAIgGQgJgIgOAAQgMAAgIAKg");
	this.shape_44.setTransform(150,47.3);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_45.setTransform(139.2,46.9);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("rgba(0,0,0,0.506)").s().p("AgcApQgNgNgBgXQgBgVAMgRQAOgUAXAAQAUAAAKASQAIAPgBAUQAAAVgLAPQgMASgUAAQgQAAgMgNgAgRgTQgGALAAANQAAAOAIAIQAGAHAJAAQAJAAAHgIQAJgIAAgOQACglgWAAQgOAAgIAOg");
	this.shape_46.setTransform(123.2,47.4);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("rgba(0,0,0,0.506)").s().p("AgGBIQgDgDAAgFIAAgEIABgFIgBgOIgBgOIgCgnIgDgnIgIAAQgWAAgMgCQgIgDAAgHQAAgFADgCQADgDAEAAIAQACIAQABIARAAIARgBIAWABIAXABQAEAAADADQADADAAAEQAAAFgDACQgDADgEAAIgXgBIgWgBIgHAAIADAsQACAbAAAQIABAKIAAAKQAAAHgCAFQgCAGgGAAQgDAAgDgCg");
	this.shape_47.setTransform(112.2,44.9);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("rgba(0,0,0,0.506)").s().p("AgHAJQgEgEAAgFQAAgEAEgDQADgEAEAAQAFAAAEAEQADADAAAEQAAAFgDAEQgEADgFAAQgEAAgDgDg");
	this.shape_48.setTransform(265.2,46.1);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("rgba(0,0,0,0.506)").s().p("AAYAwIgCgWIgCgVIABgJIAAgJQAAgVgIAAQgLAAgJANQgJAMgFARIgBAKIAAAJIAAAJIABAJQgBAEgCADQgDACgEAAQgEAAgDgCQgCgDAAgEIgBgJIgBgJIACgbIABgcIAAgJIAAgJQgBgFADgCQADgDAEAAQAJAAABANIAAALQARgWAQAAQAQAAAFAOQAFAJAAASIAAAKIAAAIQAAAIACANQACANAAAIQAAAEgCADQgDADgEAAQgJAAgBgJg");
	this.shape_49.setTransform(257.7,41.4);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("rgba(0,0,0,0.506)").s().p("AgIBHQgDgDgBgEIAAgSIAAgSIABgWIABgWQAAgFADgDQACgCAFAAQACAAADACQADADAAAFIgBAWIgBAWIABASIAAASQAAAEgDADQgDADgDgBQgEABgCgDgAgGg1QgDgEAAgEQAAgFADgDQAEgEADABQAFgBAEAEQADADAAAFQAAAEgDAEQgEAEgFgBQgDABgEgEg");
	this.shape_50.setTransform(249.6,39.1);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("rgba(0,0,0,0.506)").s().p("AAGAcIgEgXIgCgUIgIARIgPApIgDAFQgDAGgHAAQgHAAgIgdQgDgPgEgZIgCgPIgBgOQAAgFADgCQACgDAFAAQAHAAACAIIACAOIACAPIAFArQALgdAMgoQADgLAHAAQAIAAACANIAHAjIAHAlIAHgaIANg1QABgGAHAAQAEAAADADQADADAAAEIgBAEQgHAggNAnQgDAJgGAKQgDAFgHAAQgKgBgGgag");
	this.shape_51.setTransform(239.8,41.7);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("rgba(0,0,0,0.506)").s().p("AgFBEQgEgCAAgDIABgMIAAgLIgCg4IgVgBQgJgCAAgIQAAgFACgCQADgDAEAAIAUACIAAgOIAAgMQAAgEACgDQADgCAEAAQAJAAABAOIAAAIIAAAGIAAAHIAOgCQAKAAADABQAGACAAAHQAAAEgCADQgEADgDAAIgGAAIgEAAIgOABIACA4IAAAFIAAAFQABAVgLABQgCAAgDgEg");
	this.shape_52.setTransform(211.8,39.9);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_53.setTransform(195.9,41.1);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("rgba(0,0,0,0.506)").s().p("AgJBHQgCgDAAgEIAAgSIgBgSIABgWIABgWQAAgFACgDQADgCAFAAQADAAADACQACADAAAFIgBAWIgBAWIABASIAAASQAAAEgDADQgCADgEgBQgEABgDgDgAgGg1QgDgEAAgEQAAgFADgDQAEgEADABQAGgBADAEQADADAAAFQAAAEgDAEQgDAEgGgBQgDABgEgEg");
	this.shape_54.setTransform(188.7,39.1);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("rgba(0,0,0,0.506)").s().p("AgKAtIgPgnIgRgsIgBgFQAAgEADgDQADgCAEgBQAGAAACAHIAZBCIASgsIAIgWQADgGAFAAQAEAAADADQADACAAAEQAAAEgQAnIgUAsQAAAKgIgBQgHAAgDgIg");
	this.shape_55.setTransform(164,41.5);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("rgba(0,0,0,0.506)").s().p("AglAtIAAhEIAAgJIAAgKQABgKAIAAQAKAAAAAQQASgSAXAAQAHAAAEAGQAEAGAAAMIAAAHQAAAMgKAAQgIAAAAgJIgBgHIAAgIQgPABgIAHQgJAHgGAMIABA1QAAAKgKAAQgJAAAAgKg");
	this.shape_56.setTransform(154.5,41.6);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_57.setTransform(133.3,41.1);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("rgba(0,0,0,0.506)").s().p("AgcApQgNgNgBgXQgBgVAMgRQAOgUAXAAQAUAAAKASQAIAPgBAUQAAAVgLAPQgMASgUAAQgQAAgMgNgAgRgTQgGALAAANQAAAOAIAIQAGAHAJAAQAJAAAHgIQAJgIAAgOQACglgWAAQgOAAgIAOg");
	this.shape_58.setTransform(117.3,41.6);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("rgba(0,0,0,0.506)").s().p("AgGBHQgDgCAAgEIAAgFIABgEIgBgOIgBgPIgCgnIgDgmIgIAAQgWAAgMgEQgIgBAAgJQAAgDADgEQADgDAEAAIAQACIAQABIARAAIARAAIAWABIAXABQAEAAADADQADADAAAEQAAAFgDADQgDACgEAAIgXgBIgWgBIgHAAIADAsQACAbAAAPIABALIAAALQAAAGgCAFQgCAHgGAAQgDAAgDgEg");
	this.shape_59.setTransform(106.3,39.1);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("rgba(0,0,0,0.506)").s().p("AgIAJQgDgEAAgFQAAgDADgEQAEgEAEABQAEgBAEAEQAEAEAAADQAAAFgEAEQgEACgEAAQgEAAgEgCg");
	this.shape_60.setTransform(293.2,243.4);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("rgba(0,0,0,0.506)").s().p("AgfAoQgOgMAAgUQAAgYAMgQQAMgSAVAAQAPAAAKAFQAMAHAAANQAAAJgLAIIgUAJIgiARQAFAIAIAEQAIAEAJAAQAGAAAJgDQALgDADgFQADgFAEAAQADAAADADQACACAAADQAAALgQAHQgPAHgNAAQgUAAgNgLgAgSgYQgIAJgEAQIAdgMQAQgJAHgGQgIgHgOAAQgLAAgHAJg");
	this.shape_61.setTransform(285.7,239.1);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("rgba(0,0,0,0.506)").s().p("AAWAuIgCgVIgBgVIAAgHIABgJQgBgUgHAAQgKAAgJAMQgIAMgGAQIAAAJIgBAJIABAIIAAAIQAAAFgCACQgDADgEAAQgEAAgCgDQgDgCAAgFIgBgIIAAgIIABgaIABgaIAAgJIAAgIQAAgEADgDQADgDADAAQAJAAAAANIABAKQAPgVAQABQAPgBAFANQAFAJAAARIAAAJIAAAIQAAAIACAMIACAUQAAAEgDACQgCADgFAAQgHAAgCgIg");
	this.shape_62.setTransform(275.6,239);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("rgba(0,0,0,0.506)").s().p("AgIBDQgDgCABgFIgBgQIAAgRIABgWIABgUQAAgFACgCQADgDAEAAQACAAADADQACACAAAFIAAAUIgBAWIAAARIABAQQgBAFgCACQgDADgCAAQgEAAgDgDgAgFgyQgDgEgBgEQABgEADgEQADgDADAAQAFAAADADQADAEABAEQgBAEgDAEQgDADgFAAQgDAAgDgDg");
	this.shape_63.setTransform(267.9,236.8);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("rgba(0,0,0,0.506)").s().p("AgKBDIABghIABgiIABghIAAghQAAgKAIAAQAKAAAAAKIgBAhIAAAhIgCAuIAAAVQgBAKgIAAQgJAAAAgKg");
	this.shape_64.setTransform(262.5,236.4);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("rgba(0,0,0,0.506)").s().p("AAZBHQgFgKgKgMIgPgWIgRAMIgBAbQAAAEgCADQgDADgEgBQgKAAAAgMIABgXIACgXIAAgfIAAghIAAgJIAAgKQAAgEADgCQACgEAEAAQAEAAACAEQADACAAAEIAAAKIABAKIgBAeIAAAfQANgKAKgKIAUgVQAEgDADAAQAEAAADADQADACgBAEQABADgDAEQgMANgQAOIAUAcQAPATAAAGQgBAEgDADQgCACgFAAQgFABgCgGg");
	this.shape_65.setTransform(249.6,236.5);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("rgba(0,0,0,0.506)").s().p("AgaApQgNgMAAgUQAAgSANgUQANgWARAAQAJAAALAEQAOAFAAAIQAAAEgCADQgCACgEAAQAAAAgBAAQgBAAAAAAQgBAAAAgBQgBAAAAAAIgEgEQgGgEgMAAQgJAAgJARQgIAPAAALQAAAMAIAHQAIAHALAAQAGAAAGgDIALgGIAEgCQADAAADADQACADAAADQAAAHgOAHQgNAFgIAAQgSAAgNgLg");
	this.shape_66.setTransform(239.1,239.1);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_67.setTransform(229.3,239.2);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_68.setTransform(219.1,236.6);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("rgba(0,0,0,0.506)").s().p("AgfAoQgOgMAAgUQAAgYAMgQQAMgSAVAAQAPAAAKAFQAMAHAAANQAAAJgLAIIgUAJIgiARQAFAIAIAEQAIAEAJAAQAGAAAJgDQALgDADgFQADgFAEAAQADAAADADQACACAAADQAAALgQAHQgPAHgNAAQgUAAgNgLgAgSgYQgIAJgEAQIAdgMQAQgJAHgGQgIgHgOAAQgLAAgHAJg");
	this.shape_69.setTransform(202.5,239.1);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_70.setTransform(191.7,236.6);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("rgba(0,0,0,0.506)").s().p("AgFBBQgDgCAAgEIAAgKIAAgLIgBg1IgUgCQgJgBAAgIQAAgEACgDQADgCAEAAIATABIAAgMIgBgMQAAgEADgCQADgDAEAAQAHAAABAOIABAIIgBAFIAAAGIAOgBQAKAAACABQAGABAAAHQAAAEgDADQgCADgEAAIgFAAIgEgBIgNACIACA2IAAAEIAAAEQABAVgLAAQgDAAgCgDg");
	this.shape_71.setTransform(181.6,237.5);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("rgba(0,0,0,0.506)").s().p("AgbAnQgMgNgBgVQgBgUAMgQQANgTAWAAQASAAAKARQAHAOAAATQAAAUgLAOQgLARgTAAQgQAAgLgMgAgQgSQgGAKAAANQAAANAIAIQAGAGAIAAQAJAAAHgHQAHgIABgNQABgjgUAAQgNAAgIANg");
	this.shape_72.setTransform(166.3,239.2);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("rgba(0,0,0,0.506)").s().p("AgFBBQgDgCAAgEIAAgKIAAgLIgBg1IgVgCQgIgBAAgIQAAgEACgDQADgCAEAAIATABIAAgMIgBgMQAAgEADgCQADgDAEAAQAHAAABAOIABAIIgBAFIAAAGIAOgBQAKAAACABQAGABAAAHQAAAEgDADQgCADgEAAIgFAAIgEgBIgNACIACA2IAAAEIAAAEQAAAVgKAAQgDAAgCgDg");
	this.shape_73.setTransform(157,237.5);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("rgba(0,0,0,0.506)").s().p("AgKBDIABghIABgiIABghIAAghQAAgKAIAAQAKAAAAAKIgBAhIAAAhIgCAuIAAAVQgBAKgIAAQgJAAAAgKg");
	this.shape_74.setTransform(144.2,236.4);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("rgba(0,0,0,0.506)").s().p("AgKBDIABghIABgiIABghIAAghQAAgKAIAAQAKAAAAAKIgBAhIAAAhIgCAuIAAAVQgBAKgIAAQgJAAAAgKg");
	this.shape_75.setTransform(139,236.4);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_76.setTransform(131.6,239.2);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_77.setTransform(121.3,236.6);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("rgba(0,0,0,0.506)").s().p("AgfAoQgOgMAAgUQAAgYAMgQQAMgSAVAAQAPAAAKAFQAMAHAAANQAAAJgLAIIgUAJIgiARQAFAIAIAEQAIAEAJAAQAGAAAJgDQALgDADgFQADgFAEAAQADAAADADQACACAAADQAAALgQAHQgPAHgNAAQgUAAgNgLgAgSgYQgIAJgEAQIAdgMQAQgJAHgGQgIgHgOAAQgLAAgHAJg");
	this.shape_78.setTransform(104.7,239.1);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_79.setTransform(94,236.6);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("rgba(0,0,0,0.506)").s().p("AgFBBQgDgCAAgEIAAgKIAAgLIgBg1IgUgCQgJgBAAgIQAAgEACgDQADgCAEAAIATABIAAgMIAAgMQAAgEACgCQADgDAEAAQAHAAABAOIABAIIgBAFIAAAGIAOgBQAKAAADABQAFABAAAHQAAAEgDADQgCADgEAAIgEAAIgFgBIgNACIACA2IAAAEIAAAEQABAVgLAAQgDAAgCgDg");
	this.shape_80.setTransform(83.9,237.5);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("rgba(0,0,0,0.506)").s().p("AggA/QgNgNAAgUQAAgZANgOQANgPAUAAQALAAAGADIAIAHIADg1QACgIAHAAQAIAAAAAJQAAANgDAsQgCAMAAAOQAAAfADAQIABACQAAAEgDACQgDACgDAAQgGAAgDgIQgGAFgHADQgIACgGAAQgUAAgMgNgAgVACQgIAJAAASQAAAMAJAJQAIAIAMAAQAGAAAGgCIAKgIIADgDIgBgQIABgLIAAgLQgEgHgGgDQgFgEgJAAQgOAAgIAJg");
	this.shape_81.setTransform(68.1,236.5);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("rgba(0,0,0,0.506)").s().p("AgfAoQgOgMAAgUQAAgYAMgQQAMgSAVAAQAPAAAKAFQAMAHAAANQAAAJgLAIIgUAJIgiARQAFAIAIAEQAIAEAJAAQAGAAAJgDQALgDADgFQADgFAEAAQADAAADADQACACAAADQAAALgQAHQgPAHgNAAQgUAAgNgLgAgSgYQgIAJgEAQIAdgMQAQgJAHgGQgIgHgOAAQgLAAgHAJg");
	this.shape_82.setTransform(57.5,239.1);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("rgba(0,0,0,0.506)").s().p("AgJArIgPgmIgRgpIAAgFQAAgDADgDQADgDADAAQAGAAACAGIAYBAQAGgPALgbIAIgVQACgGAGAAQADAAADADQADACAAAEQAAADgPAlIgTAqQAAAJgIAAQgGAAgDgIg");
	this.shape_83.setTransform(47.7,239);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("rgba(0,0,0,0.506)").s().p("AgjArIAAhAIAAgJIAAgJQABgKAHAAQAJAAAAAPQASgRAVAAQAIAAADAGQAEAGAAALIAAAHQAAALgJAAQgIAAAAgJIgBgHIAAgIQgPACgHAHQgIAGgGAMIAAAyQAAAJgJAAQgIAAAAgJg");
	this.shape_84.setTransform(38.6,239.1);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("rgba(0,0,0,0.506)").s().p("AgfAoQgOgMAAgUQAAgYAMgQQAMgSAVAAQAPAAAKAFQAMAHAAANQAAAJgLAIIgUAJIgiARQAFAIAIAEQAIAEAJAAQAGAAAJgDQALgDADgFQADgFAEAAQADAAADADQACACAAADQAAALgQAHQgPAHgNAAQgUAAgNgLgAgSgYQgIAJgEAQIAdgMQAQgJAHgGQgIgHgOAAQgLAAgHAJg");
	this.shape_85.setTransform(28.7,239.1);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_86.setTransform(18.5,238.7);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("rgba(0,0,0,0.506)").s().p("AAZBHQgFgKgKgMIgPgWIgRAMIgBAbQAAAEgDADQgCADgEgBQgKAAABgMIABgXIABgXIAAgfIABghIgBgJIAAgKQAAgEACgCQADgEAEAAQAEAAADAEQACACAAAEIABAKIAAAKIgBAeIAAAfQAMgKALgKIAVgVQADgDADAAQAEAAADADQADACAAAEQAAADgDAEQgLANgRAOIAUAcQAOATAAAGQAAAEgCADQgEACgDAAQgFABgDgGg");
	this.shape_87.setTransform(3.9,236.5);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("rgba(0,0,0,0.506)").s().p("AgaApQgNgMAAgUQAAgSANgUQANgWARAAQAJAAALAEQAOAFAAAIQAAAEgCADQgCACgEAAQAAAAgBAAQgBAAAAAAQgBAAAAgBQgBAAAAAAIgEgEQgGgEgMAAQgJAAgJARQgIAPAAALQAAAMAIAHQAIAHALAAQAGAAAGgDIALgGIAEgCQADAAADADQACADAAADQAAAHgOAHQgNAFgIAAQgSAAgNgLg");
	this.shape_88.setTransform(-6.7,239.1);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("rgba(0,0,0,0.506)").s().p("AgIBDQgCgCAAgFIgBgQIgBgRIACgWIABgUQAAgFACgCQADgDAEAAQADAAACADQADACAAAFIgBAUIgBAWIAAARIABAQQAAAFgDACQgCADgDAAQgEAAgDgDgAgFgyQgEgEABgEQgBgEAEgEQADgDADAAQAFAAAEADQACAEAAAEQAAAEgCAEQgEADgFAAQgDAAgDgDg");
	this.shape_89.setTransform(-14.1,236.8);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f("rgba(0,0,0,0.506)").s().p("");
	this.shape_90.setTransform(-25.2,237);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17}]},87).to({state:[]},71).to({state:[{t:this.shape_47},{t:this.shape_46,p:{x:123.2,y:47.4}},{t:this.shape_45},{t:this.shape_44,p:{x:150,y:47.3}},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41,p:{x:180.3,y:47.3}},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34}]},9).to({state:[]},74).to({state:[{t:this.shape_59},{t:this.shape_58},{t:this.shape_57},{t:this.shape_44,p:{x:144.1,y:41.5}},{t:this.shape_56},{t:this.shape_55},{t:this.shape_41,p:{x:174.4,y:41.5}},{t:this.shape_54},{t:this.shape_53},{t:this.shape_52},{t:this.shape_46,p:{x:221.5,y:41.6}},{t:this.shape_51},{t:this.shape_50},{t:this.shape_49},{t:this.shape_48}]},16).to({state:[]},84).to({state:[{t:this.shape_90},{t:this.shape_89},{t:this.shape_88},{t:this.shape_87},{t:this.shape_86},{t:this.shape_85},{t:this.shape_84},{t:this.shape_83},{t:this.shape_82},{t:this.shape_81},{t:this.shape_80},{t:this.shape_79},{t:this.shape_78},{t:this.shape_77},{t:this.shape_76},{t:this.shape_75},{t:this.shape_74},{t:this.shape_73},{t:this.shape_72},{t:this.shape_71},{t:this.shape_70},{t:this.shape_69},{t:this.shape_68},{t:this.shape_67},{t:this.shape_66},{t:this.shape_65},{t:this.shape_64},{t:this.shape_63},{t:this.shape_62},{t:this.shape_61},{t:this.shape_60}]},109).wait(169));

	// Formula
	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f("#FF00FF").s().p("");
	this.shape_91.setTransform(305.3,317.2);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("#FF00FF").s().p("AgRBHQgMgegOg2IgIgbQgGgUAAgGQAAgFAEgDQACgCAEAAQAIAAACAHIAEARIAJAhQAJAkAJAbIABgCIAZhGIAIgYQAGgOAGgIQADgEAFAAQAEAAADADQADADAAAFQAAACgCADQgGAJgEAKIgHAWIgbBGQgEAMgHAMQgCAGgFAAQgIAAgDgIg");
	this.shape_92.setTransform(292.8,317.4);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f("#FF00FF").s().p("AgqBIQgDgDAAgEQAAgEADgDQACgDAEAAIAWgCIABgSIgBgRIAAgQQAAgWACgiIgMABIgOAAQgDAAgEgDQgCgDAAgEQAAgJAJgBIAdgBQATAAAeAFQAIABAAAJQAAAFgEACQgCADgEAAIgQgCIgQgCQgBAdAAAZIAAAQIAAARIAAARIAeAAQAEAAADADQADACAAAFQAAAEgDADQgDADgEAAIgRAAIgPAAIgTACIgUACQgEAAgCgDg");
	this.shape_93.setTransform(280.3,317.4);

	this.shape_94 = new cjs.Shape();
	this.shape_94.graphics.f("#FF00FF").s().p("AgGBHQgDgCAAgEIAAgFIABgEIgBgPIgBgOIgCgnIgDgmIgIAAQgWAAgMgEQgIgBAAgJQAAgDADgEQADgDAEAAIAQACIAQABIARAAIARAAIAWABIAXABQAEAAADADQADADAAAEQAAAFgDADQgDACgEAAIgXgBIgWgBIgHAAIADAsQACAbAAAPIABALIAAALQAAAGgCAFQgCAHgGAAQgDAAgDgEg");
	this.shape_94.setTransform(268.8,317.2);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f("#FF00FF").s().p("AgqBIQgDgDAAgEQAAgEADgDQADgDAEAAIAVgCIABgSIgBgRIAAgQQgBgWADgiIgMABIgOAAQgDAAgDgDQgDgDAAgEQAAgJAJgBIAegBQASAAAdAFQAJABAAAJQAAAFgDACQgDADgEAAIgQgCIgQgCQgCAdAAAZIAAAQIABARIgBARIAfAAQAEAAADADQADACAAAFQAAAEgDADQgDADgEAAIgQAAIgQAAIgTACIgTACQgEAAgDgDg");
	this.shape_95.setTransform(255.7,317.4);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f("#FF00FF").s().p("AhBBNQgCgDAAgFIAAgNIABgMIAAgSIABgSIgBgSIAAgUIgBgSIgBgSQAAgFAEgEQADgDAFgBQAFAAAIAMQAYAkATAYQAXAcAcAaIAAgMIgBgMQAAgrgDgZIgDgKIgCgKQAAgMAKAAQARAAABA/IAAAgIgBAhIgBAPQgCAKgJAAQgGAAgHgHQgogmgyhFIgBAVIAAAWIAAAYIABAYQAAAbgKAAQgFAAgEgDg");
	this.shape_96.setTransform(242.4,317.3);

	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.f("#FF00FF").s().p("AgqBIQgDgDAAgEQAAgEADgDQADgDAEAAIAUgCIABgSIAAgRIgBgQQABgWACgiIgMABIgOAAQgEAAgCgDQgDgDAAgEQAAgJAJgBIAegBQASAAAdAFQAJABAAAJQAAAFgDACQgDADgEAAIgQgCIgQgCQgCAdAAAZIAAAQIABARIgBARIAfAAQAEAAADADQADACAAAFQAAAEgDADQgDADgEAAIgQAAIgQAAIgTACIgTACQgEAAgDgDg");
	this.shape_97.setTransform(228.8,317.4);

	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.f("#FF00FF").s().p("AgvBPQgCgDAAgEIAAg6IABg4IAAgOIAAgMQAAgFADgDQACgCAEAAQAEgBACACIAWgDIAQgBQALAAAPADQATAFAAAHQAAADgCAEQgDADgEAAIgEgBQgMgEgUAAIgOABIgTACIgBArQATgFAKAAIAeABQAJACAAAJQAAAEgDADQgDACgEAAIgPgBIgOAAQgHAAgWAEIgBBEQAAAEgDADQgCADgFAAQgEAAgDgDg");
	this.shape_98.setTransform(217.8,317.4);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.f("#FF00FF").s().p("AhBBNQgDgDABgFIAAgNIABgMIAAgSIAAgSIAAgSIAAgUIgBgSIgBgSQAAgFADgEQAEgDAFgBQAFAAAIAMQAYAkATAYQAXAcAbAaIAAgMIAAgMQAAgrgDgZIgDgKIgCgKQAAgMAKAAQARAAAAA/IAAAgIAAAhIgBAPQgCAKgJAAQgGAAgHgHQgogmgyhFIgBAVIAAAWIAAAYIABAYQAAAbgKAAQgFAAgEgDg");
	this.shape_99.setTransform(203.3,317.3);

	this.shape_100 = new cjs.Shape();
	this.shape_100.graphics.f("#FF00FF").s().p("AgqBIQgDgDAAgEQAAgEADgDQACgDAFAAIAUgCIABgSIAAgRIgBgQQABgWACgiIgNABIgMAAQgFAAgCgDQgDgDAAgEQAAgJAJgBIAegBQASAAAdAFQAJABAAAJQAAAFgDACQgDADgEAAIgQgCIgPgCQgDAdAAAZIAAAQIABARIgBARIAfAAQAEAAADADQADACAAAFQAAAEgDADQgDADgEAAIgQAAIgRAAIgSACIgTACQgFAAgCgDg");
	this.shape_100.setTransform(189.8,317.4);

	this.shape_101 = new cjs.Shape();
	this.shape_101.graphics.f("#000000").s().p("AAJAjIgTAAIgIAAIgJAAQgJAAAAgIQAAgIAIgBIASgBIATAAIATABQAJAAAAAIQAAAJgJAAIgTAAgAgjgTQgCgDAAgDQAAgHAIgCIAOAAIAsAAQAJAAAAAIQAAAJgJAAIgsAAIgHAAIgGABQgEAAgDgDg");
	this.shape_101.setTransform(172.8,318.3);

	this.shape_102 = new cjs.Shape();
	this.shape_102.graphics.f("#FF0000").s().p("");
	this.shape_102.setTransform(156.2,317.1);

	this.shape_103 = new cjs.Shape();
	this.shape_103.graphics.f("#FF0000").s().p("");
	this.shape_103.setTransform(143.4,317.2);

	this.shape_104 = new cjs.Shape();
	this.shape_104.graphics.f("#FF0000").s().p("");
	this.shape_104.setTransform(131,317.2);

	this.shape_105 = new cjs.Shape();
	this.shape_105.graphics.f("#FF0000").s().p("AgRBHQgMgegOg2IgIgbQgGgUAAgGQAAgFAEgDQACgCAEAAQAIAAACAHIAEARIAJAhQAJAkAJAbIABgCIAZhGIAIgYQAGgOAGgIQADgEAFAAQAEAAADADQADADAAAFQAAACgCADQgGAJgEAKIgHAWIgbBGQgEAMgHAMQgCAGgFAAQgIAAgDgIg");
	this.shape_105.setTransform(118.5,317.4);

	this.shape_106 = new cjs.Shape();
	this.shape_106.graphics.f("#000000").s().p("AgHAlQgCgCAAgEIAAgLIAAgMIgRABQgPAAAAgJQAAgFAFgCIAKAAIARgBIAAgMIABgMQABgDACgCQACgCADAAQADAAACADQADACAAAEIgBAFIAAAFIAAALIAHABIAGAAIAGgBQAQAAAAAJQAAADgCADQgCACgEAAIgEAAIgDAAIgKAAIgKAAIAAAXQAAAJgHAAQgFAAgCgDg");
	this.shape_106.setTransform(100.4,318.3);

	this.shape_107 = new cjs.Shape();
	this.shape_107.graphics.f("#000000").s().p("AgcApQgNgNgBgXQgBgVAMgRQAOgUAXAAQAUAAAKASQAIAPgBAUQAAAVgLAPQgMASgUAAQgQAAgMgNgAgRgTQgGALAAANQAAAOAIAIQAGAHAJAAQAJAAAHgIQAJgIAAgOQACglgWAAQgOAAgIAOg");
	this.shape_107.setTransform(84.4,319.7);

	this.shape_108 = new cjs.Shape();
	this.shape_108.graphics.f("#000000").s().p("AgGBHQgDgCAAgEIAAgFIABgEIgBgPIgBgOIgCgnIgDgmIgIAAQgWAAgMgEQgIgBAAgJQAAgDADgEQADgDAEAAIAQACIAQABIARAAIARAAIAWABIAXABQAEAAADADQADADAAAEQAAAFgDADQgDACgEAAIgXgBIgWgBIgHAAIADAsQACAbAAAPIABALIAAALQAAAGgCAFQgCAHgGAAQgDAAgDgEg");
	this.shape_108.setTransform(73.4,317.2);

	this.shape_109 = new cjs.Shape();
	this.shape_109.graphics.f("#0099FF").s().p("Ag6BFQgDgDAAgEIABgLIAAgLIABgQIAAgRIAAgQIAAgSIgBgQIgCgRQAAgEAEgDQAEgEAEAAQAFAAAGALQAWAgARAWQAVAZAYAXIAAgLIAAgLQAAglgDgXIgCgKIgCgJQAAgKAJAAQAPAAAAA5IAAAcIAAAdIgCAOQgBAJgIAAQgFAAgGgGQgkgigtg/IgBAUIAAATIAAAWIABAWQgBAYgIAAQgGAAgCgDg");
	this.shape_109.setTransform(292.9,320.8);

	this.shape_110 = new cjs.Shape();
	this.shape_110.graphics.f("#0099FF").s().p("AgsA2QgSgQAAgZQAAgdASgZQAUgbAeAAQAdAAAOANQAOANAAAdQAAAegQAYQgUAcgdAAQgYAAgSgPgAgegdQgOAUAAAWQAAARANALQAMAKARAAQAVAAANgVQANgUAAgXQAAgVgKgIQgIgIgVAAQgVAAgPAVg");
	this.shape_110.setTransform(278.5,320.9);

	this.shape_111 = new cjs.Shape();
	this.shape_111.graphics.f("#0099FF").s().p("AgmBBQgCgDAAgEQAAgDACgDQADgDADAAIATgBIABgRIAAgOIgBgPQAAgUADgeIgMAAIgLABQgEAAgDgDQgCgCAAgEQAAgJAIAAIAbgBQAQAAAbAEQAHABAAAIQAAAEgDADQgCACgEAAIgOgBIgOgCQgCAZAAAXIAAAPIABAPIgBAPIAcAAQAEAAACACQADADAAAEQAAAEgDACQgCADgEAAIgPAAIgPAAIgQACIgSABQgDAAgDgCg");
	this.shape_111.setTransform(266.3,320.9);

	this.shape_112 = new cjs.Shape();
	this.shape_112.graphics.f("#0099FF").s().p("AgFBAQgDgCAAgEIAAgEIABgEIgBgNIAAgNIgCgiIgDgjIgIAAQgTAAgLgDQgHgCAAgHQAAgDACgDQADgDAEAAIAOACIAOABIAQAAIAPgBIAUABIAUABQAEAAADADQACACAAAEQAAAEgCADQgDACgEAAIgUgBIgUgBIgGAAQAAAMADAcIABAmIABAJIABAKQAAAGgCAEQgDAGgFAAQgCAAgDgDg");
	this.shape_112.setTransform(256,320.7);

	this.shape_113 = new cjs.Shape();
	this.shape_113.graphics.f("#0099FF").s().p("AgmBBQgCgDAAgEQAAgDACgDQADgDADAAIATgBIABgRIAAgOIgBgPQAAgUADgeIgMAAIgLABQgEAAgDgDQgCgCAAgEQAAgJAIAAIAbgBQAQAAAbAEQAHABAAAIQAAAEgDADQgCACgEAAIgOgBIgOgCQgCAZAAAXIAAAPIABAPIgBAPIAcAAQAEAAACACQADADAAAEQAAAEgDACQgCADgEAAIgPAAIgPAAIgQACIgSABQgDAAgDgCg");
	this.shape_113.setTransform(244.3,320.9);

	this.shape_114 = new cjs.Shape();
	this.shape_114.graphics.f("#0099FF").s().p("AgiA9QgRgIAAgNQAAgDADgDQACgCAEAAQAEAAADAEQAFAIADABQAIAGAOAAQANgBALgFQAPgIAAgNQAAgLgMgHQgLgFgOgBQgOAAgKgFQgNgHAAgNQAAgQASgNQARgMARAAQAJAAALADQAOAEAAAFQAAAJgIgBIgMgBIgOgCQgNAAgJAGQgKAHAAAKQAAAHANADQAFACANABQAUABALALQAKAJAAAPQAAAVgTAMQgRALgVAAQgQAAgNgGg");
	this.shape_114.setTransform(233.2,321.1);

	this.shape_115 = new cjs.Shape();
	this.shape_115.graphics.f("#0099FF").s().p("AgrA2QgTgQAAgZQAAgdASgZQAVgbAcAAQAdAAAOANQAPANAAAdQAAAegQAYQgUAcgdAAQgYAAgRgPgAgegdQgOAUAAAWQAAARAMALQANAKARAAQAVAAANgVQANgUAAgXQAAgVgJgIQgJgIgWAAQgUAAgPAVg");
	this.shape_115.setTransform(219.8,320.9);

	this.shape_116 = new cjs.Shape();
	this.shape_116.graphics.f("#0099FF").s().p("AglBDQgCgCAAgDIAAgaIACgkIACgkIAAgMIABgMQACgJAGABIAIAAIANgBQAPAAAOALQAQAMAAARQAAAWgRAMQgPAMgTgBIgLgBIgBAvQAAADgCACQgCADgEAAQgDAAgDgDgAgOg0IgFABIAAAQIgCAiIAKABQANAAAKgHQALgIAAgOQAAgKgKgHQgKgHgKABIgHAAg");
	this.shape_116.setTransform(208,320.5);

	this.shape_117 = new cjs.Shape();
	this.shape_117.graphics.f("#0099FF").s().p("");
	this.shape_117.setTransform(197.9,320.7);

	this.shape_118 = new cjs.Shape();
	this.shape_118.graphics.f("#0099FF").s().p("");
	this.shape_118.setTransform(186.6,320.7);

	this.shape_119 = new cjs.Shape();
	this.shape_119.graphics.f("#0099FF").s().p("AglBDQgCgCAAgDIAAgaIACgkIACgkIAAgMIABgMQACgJAGABIAIAAIANgBQAPAAAOALQAQAMAAARQAAAWgRAMQgPAMgTgBIgLgBIgBAvQAAADgCACQgCADgEAAQgDAAgDgDgAgOg0IgFABIAAAQIgCAiIAKABQANAAAKgHQALgIAAgOQAAgKgKgHQgKgHgKABIgHAAg");
	this.shape_119.setTransform(176.2,320.5);

	this.shape_120 = new cjs.Shape();
	this.shape_120.graphics.f("#000000").s().p("AAIAgIgRgBIgIABIgHAAQgJAAABgIQgBgHAIgBIAQAAIARAAIARAAQAIAAAAAIQAAAIgIAAIgRAAgAgfgRQgCgCAAgDQgBgHAIgBIANgBIAnABQAJAAgBAHQABAIgJAAIgnAAIgHAAIgGABQgDAAgCgDg");
	this.shape_120.setTransform(161,321.7);

	this.shape_121 = new cjs.Shape();
	this.shape_121.graphics.f("#0033FF").s().p("Ag7BFQgCgDAAgEIAAgLIABgLIAAgQIABgRIgBgQIAAgSIgBgQIAAgRQAAgEADgDQAEgEADAAQAFAAAHALQAWAgARAWQAVAZAYAXIAAgLIAAgLQAAglgDgXIgDgKIgBgJQAAgKAJAAQAQAAAAA5IgBAcIAAAdIgBAOQgCAJgIAAQgEAAgIgGQgjgigug/IAAAUIAAATIAAAWIAAAWQABAYgKAAQgFAAgDgDg");
	this.shape_121.setTransform(144.3,320.8);

	this.shape_122 = new cjs.Shape();
	this.shape_122.graphics.f("#0033FF").s().p("AgmA0QgLgNgDgYQgBgMAAggIAAgUIACgLQACgGAGAAQAIAAAAAOIAAA0QAAA0AkAAQAjAAAAhYIAAgJIAAgHQAAgFACgFQADgFAEAAQAJAAAAAMIAAALIAAALQAABlg0AAQgbAAgNgQg");
	this.shape_122.setTransform(130.5,320.9);

	this.shape_123 = new cjs.Shape();
	this.shape_123.graphics.f("#0033FF").s().p("AgrA2QgTgQAAgZQAAgdASgZQAVgbAcAAQAdAAAOANQAPANAAAdQAAAegQAYQgTAcgeAAQgZAAgQgPgAgegdQgOAUAAAWQAAARANALQAMAKARAAQAVAAANgVQANgUAAgXQAAgVgJgIQgJgIgWAAQgUAAgPAVg");
	this.shape_123.setTransform(116.7,320.9);

	this.shape_124 = new cjs.Shape();
	this.shape_124.graphics.f("#0033FF").s().p("Ag7BFQgCgDAAgEIABgLIAAgLIAAgQIABgRIgBgQIAAgSIAAgQIgBgRQgBgEAEgDQAEgEADAAQAFAAAHALQAWAgARAWQAUAZAZAXIAAgLIAAgLQAAglgDgXIgDgKIgBgJQAAgKAJAAQAQAAAAA5IgBAcIAAAdIgCAOQgBAJgIAAQgEAAgIgGQgjgigug/IAAAUIAAATIAAAWIAAAWQABAYgKAAQgEAAgEgDg");
	this.shape_124.setTransform(102.4,320.8);

	this.shape_125 = new cjs.Shape();
	this.shape_125.graphics.f("#000000").s().p("AgGAiQgCgCAAgEIAAgKIAAgKIgPAAQgOAAAAgIQAAgFAFgBIAJAAIAPgBIAAgKIABgLQABgEABgBQABgBAAAAQABAAAAAAQABgBABAAQAAAAABAAQACAAADADQACACAAADIAAAFIgBAFIAAAKIAHAAIAGAAIAFgBQAOAAAAAIQAAADgCACQgCADgEAAIgCgBIgEAAIgJAAIgJAAIAAAVQABAIgHAAQgEAAgCgCg");
	this.shape_125.setTransform(85.2,321.7);

	this.shape_126 = new cjs.Shape();
	this.shape_126.graphics.f("#000000").s().p("AgZAmQgMgNgBgUQAAgTAKgQQAMgRAVAAQASAAAJAQQAHANAAASQAAASgKAPQgMAPgRAAQgPAAgKgKgAgPgRQgGAKAAAMQAAANAHAGQAGAHAIAAQAIgBAHgGQAHgIABgMQABghgUgBQgMAAgHANg");
	this.shape_126.setTransform(70.8,323);

	this.shape_127 = new cjs.Shape();
	this.shape_127.graphics.f("#000000").s().p("AgFBAQgDgCAAgEIAAgEIABgEIgBgNIAAgNIgCgiIgDgjIgIAAQgTAAgLgDQgHgCAAgHQAAgDACgDQADgDAEAAIAOACIAOABIAQAAIAPgBIAUABIAUABQAEAAADADQACACAAAEQAAAEgCADQgDACgEAAIgUgBIgUgBIgGAAQAAAMADAcIABAmIABAJIABAKQAAAGgCAEQgDAGgFAAQgCAAgDgDg");
	this.shape_127.setTransform(60.8,320.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_108},{t:this.shape_107},{t:this.shape_106},{t:this.shape_105},{t:this.shape_104},{t:this.shape_103},{t:this.shape_102},{t:this.shape_101},{t:this.shape_100},{t:this.shape_99},{t:this.shape_98},{t:this.shape_97},{t:this.shape_96},{t:this.shape_95},{t:this.shape_94},{t:this.shape_93},{t:this.shape_92},{t:this.shape_91}]},34).to({state:[]},321).to({state:[{t:this.shape_127},{t:this.shape_126},{t:this.shape_125},{t:this.shape_124},{t:this.shape_123},{t:this.shape_122},{t:this.shape_121},{t:this.shape_120},{t:this.shape_119},{t:this.shape_118},{t:this.shape_117},{t:this.shape_116},{t:this.shape_115},{t:this.shape_114},{t:this.shape_113},{t:this.shape_112},{t:this.shape_111},{t:this.shape_110},{t:this.shape_109}]},68).wait(196));

	// carat
	this.instance_20 = new lib.CaratforDiagram();
	this.instance_20.parent = this;
	this.instance_20.setTransform(321.9,25.7,0.758,0.758,0,0,0,65.5,37.8);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(46).to({_off:false},0).to({alpha:1},6).wait(42).to({x:292,y:104.3},9).wait(77).to({x:53.2},15).wait(147).to({y:73.5},5).to({x:327.9,y:56.8},10).to({x:322.3,y:25},6).wait(256));

	// Infinitive
	this.instance_21 = new lib.InfinitiveBuiltonaCarat();
	this.instance_21.parent = this;
	this.instance_21.setTransform(119,68.5,1.054,1.054,0,0,0,157.8,16);

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(22).to({regY:15.9,scaleX:0.86,scaleY:0.86,x:71.1,y:6.6},6).wait(591));

	// sentence line
	this.instance_22 = new lib.SentenceLine();
	this.instance_22.parent = this;
	this.instance_22.setTransform(190.5,130,0.782,0.782,0,0,0,205.5,29.4);
	this.instance_22.alpha = 0;
	this.instance_22._off = true;

	this.instance_23 = new lib.SentenceLineSlant();
	this.instance_23.parent = this;
	this.instance_23.setTransform(190.5,130,0.782,0.782,0,0,0,205.5,29.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_22}]},65).to({state:[{t:this.instance_22}]},6).to({state:[{t:this.instance_23}]},102).to({state:[{t:this.instance_22}]},209).to({state:[{t:this.instance_22}]},7).wait(230));
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(65).to({_off:false},0).to({alpha:1},6).to({_off:true},102).wait(209).to({_off:false},0).to({y:96.2},7).wait(230));

	// PrepDiag
	this.instance_24 = new lib.CaratforDiagram();
	this.instance_24.parent = this;
	this.instance_24.setTransform(53.2,104.3,0.758,0.758,0,0,0,65.5,37.8);
	this.instance_24._off = true;

	this.instance_25 = new lib.prepDia();
	this.instance_25.parent = this;
	this.instance_25.setTransform(16,228.5,0.714,0.714,0,0,0,76.8,48.8);
	this.instance_25.alpha = 0;
	this.instance_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(266).to({_off:false},0).to({x:301.9},10).wait(63).to({x:322.3,y:25},11).to({_off:true},14).wait(255));
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(430).to({_off:false},0).to({x:11.2,y:189.8,alpha:1},6).wait(49).to({scaleX:0.96,scaleY:0.96,x:204.4,y:147.7},11).wait(123));

	// Preposition
	this.instance_26 = new lib.Prepositionisdiagrammed();
	this.instance_26.parent = this;
	this.instance_26.setTransform(188.2,189.2,1.096,1.096,0,0,0,228.1,16);
	this.instance_26.alpha = 0;
	this.instance_26._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(365).to({_off:false},0).to({alpha:1},7).wait(44).to({scaleX:0.94,scaleY:0.94,x:152.3,y:274.7},7).wait(196));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-47.3,51.6,353.2,33.6);
...
// stage content:
(lib.inf_Scene6a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{scene6a:0,scene6a_repeat:539});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(4).call(this.frame_4).wait(85).call(this.frame_89).wait(80).call(this.frame_169).wait(90).call(this.frame_259).wait(110).call(this.frame_369).wait(80).call(this.frame_449).wait(100).call(this.frame_549).wait(1));

	// Lesson
	this.instance = new lib.InfinitivesVprepositions();
	this.instance.parent = this;
	this.instance.setTransform(248.8,79.1,1,1,0,0,0,165.1,30.4);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(480.1,268.5,0.844,0.844);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance_2},{t:this.UI}]}).wait(550));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(282.5,200.6,534,398.7);
// library properties:
lib.properties = {
	id: 'F88DDDC742B23B46B67F31B4C0232109',
	width: 550,
	height: 400,
	fps: 12,
	color: "#FFFFFF",
	...
	manifest: [
		...
		{src:"sounds/micklovestoserve.mp3", id:"micklovestoserve"},
		{src:"sounds/mickservedtheball.mp3", id:"mickservedtheball"},
		...
		{src:"sounds/toserveishard.mp3", id:"toserveishard"},
		{src:"sounds/toserveistowin.mp3", id:"toserveistowin"},
...
an.compositions['F88DDDC742B23B46B67F31B4C0232109'] = {
