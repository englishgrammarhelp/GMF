...
(lib.target = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-11.6,20);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.target, new cjs.Rectangle(-31.6,0,40,40), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol11, new cjs.Rectangle(0,0,46.1,41.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol10, new cjs.Rectangle(0,0,56.5,41.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol9, new cjs.Rectangle(0,0,39,41.6), null);
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,255,0.392)").s().p("AgcA8QgCgCAAgEIABgdIAAgcIgBgdIgCgPQAAgFACgEQADgFAEAAQADABACACQABACAAACIAAADIAAAEQAGgFAGgCQAFgCAFAAQAPAAAHANQAGALAAASQAAAPgJAJQgJAMgPAAQgGAAgJgDIAAAjQAAAEgCACQgCABgDAAQgEAAgCgBgAgGgmIgKAIIABAiQAIADAHAAQAJAAAFgHQAEgFAAgJQAAgNgDgIQgDgGgHAAQgGAAgFADg");
	this.shape.setTransform(15.4,24.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,255,0.392)").s().p("AgHA1IABgbIAAgaIAAgZIABgbQAAgHAGAAQAIAAAAAHIgBAbIAAAZIgBAlIgBAQQAAAIgGgBQgHAAAAgHg");
	this.shape_1.setTransform(9.3,20.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,255,0.392)").s().p("AgZAfQgKgIgBgRQAAgSAJgNQALgOAQAAQAMAAAHAEQAJAFAAALQAAAHgIAGIgPAHIgbANQAEAHAGACQAHAEAGAAQAGAAAHgCQAIgDADgDQACgEACgBQAEABACACQAAAAAAABQABAAAAABQAAAAAAABQAAAAAAABQAAAIgNAGQgLAFgLAAQgPAAgLgJgAgPgTQgFAHgEANIAXgKQAMgGAGgFQgGgGgLAAQgJAAgGAHg");
	this.shape_2.setTransform(3.3,22.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,255,0.392)").s().p("AAUA4IgDgRIgBgSIAAgGIAAgFQAAgNgHgBQgJAAgHAIIgKARQAAAbgCAGQgCAEgFAAQgDAAgCgCQgCgCAAgDIABgDIAAgLIABgKIAAg1IAAgNIAAgHIgBgGQAAgEACgCQACgCADAAQAGAAABAHIABAMIAAARIAAAQIAAAGQAGgIAHgEQAFgEAIAAQAMAAAFAIQADAFAAAMIABAOIABAQIADAPIAAACQAAADgCACQgCACgDAAQgFAAgCgFg");
...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,255,0.392)").s().p("AgVAfQgKgKAAgRQgBgQAJgMQAKgPASAAQAOAAAIANQAGALAAAPQAAAQgJALQgJANgPAAQgMAAgJgJgAgMgOQgFAIAAAKQAAAKAGAGQAFAFAGAAQAHAAAGgFQAGgGAAgLQABgbgQAAQgKAAgGAKg");
	this.shape.setTransform(16,15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,255,0.392)").s().p("AgEA2QgDgCAAgDIABgEIAAgDIAAgLIgBgLIgBgcIgCgeIgHABQgQAAgJgDQgGgBAAgGQAAgDACgCQACgDADAAIAMACIAMAAIANAAIANAAIAQABIARABQADAAACACQACACAAADQAAADgCADQgCACgDAAIgRgBIgQgBIgGAAIACAhIACAgIABAIIAAAHQAAAFgCAEQgCAFgEAAQgCAAgCgCg");
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,255,0.392)").s().p("AgTAoQgMgDAAgIQAAgDADgCQABgCAEAAQACAAADAEQACABAGABIAIABQAFAAAFgBQAHgCAAgFQAAgKgOgDIgGgDQgKgBgEgDQgGgDAAgJQAAgPAPgHIANgEIANgFIAHgBQADAAACACQACACAAAEIABAFIABAGQAAAEgCACQgCACgEAAQgDAAgCgCIgCgIIgRAEQgKAGAAAGIADACQARACAHAGQANAGAAAPQAAAMgLAGQgIAFgNAAQgJAAgIgEg");
	this.shape.setTransform(9.7,14.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,255,0.392)").s().p("AgGA1QgCgCAAgEIAAgMIgBgOIABgRIABgQQAAgDACgDQACgBADAAQACAAACABQACADAAADIgBAQIAAARIAAAOIAAAMQAAAEgCACQgCACgCAAQgDAAgCgCgAgEgnQgCgDAAgDQAAgEACgDQADgCACAAQAEAAACACQADADAAAEQAAADgDADQgCACgEAAQgCAAgDgCg");
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,255,0.392)").s().p("AASAkIgCgQIgBgRIAAgFIAAgHQAAgQgFAAQgJAAgGAJQgHAKgEAMIAAAHIgBAHIABAHIAAAHQAAADgCACQgCACgDAAQgDAAgCgCQgCgCAAgDIgBgHIAAgHIABgUIABgUIAAgHIgBgIQAAgCADgDQACgCADAAQAGAAABAKIAAAIQANgQAMAAQALAAAFALQADAGAAAOIAAAIIAAAFIACAQIABAQQAAACgCACQgCADgDAAQgGAAgBgHg");
	this.shape.setTransform(21.5,14.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,255,0.392)").s().p("AAQAjQgJAEgLAAQgJABgHgEQgHgFgBgJQgDgTAAgPQAAgKACgMQABgHAGAAQAEAAACACQACACAAADIgBALIgBALIAAAUIADAOIAFACIAEABQAJAAALgDIAAgPIAAgNQAAgQABgMQABgGAGAAQADAAADABQACADAAADIgCAbIAAAPIAAAQIABAFIAAAEQAAAEgCACQgCACgDAAQgGAAgCgHg");
	this.shape_1.setTransform(13.6,15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,255,0.392)").s().p("AgLA/QgCgCAAgDIAAgCQABgJAAgMIAAgUIAAgUIgLABQgIAAAAgHQAAgHANgBIAHAAIABgLQACgQAGgIQAHgJAQAAQALAAAAAHQAAAHgKAAQgSAAgCAYIAAAFIAQgBQAMAAAAAHQAAAGgGABIgGAAIgRABIAAAQIAAANIAAAOQAAAOgBAIQAAAFgGAAQgDAAgCgBg");
...
}).prototype = getMCSymbolPrototype(lib.item2, new cjs.Rectangle(0,0,24.9,41.6), null);
...
(lib.inf_Scene5c = function(mode,startPosition,loop) {
	...
	this.target4.setTransform(132.8,119.9,0.6,0.6,0,0,0,20.2,20.4);
	this.target4.visible = false;

	this.target3 = new lib.target();
	this.target3.parent = this;
	this.target3.setTransform(83.9,111.2,0.6,0.6,0,0,0,20.2,20.4);
	this.target3.visible = false;

	this.target2 = new lib.target();
	this.target2.parent = this;
	this.target2.setTransform(288.4,152.5,1,1,0,0,0,20,20);
	this.target2.visible = false;

	this.target1 = new lib.target();
	this.target1.parent = this;
	this.target1.setTransform(444.4,160.3,1,1,0,0,0,20,20);
	this.target1.visible = false;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.target1},{t:this.target2},{t:this.target3},{t:this.target4},{t:this.item3},{t:this.item4},{t:this.item2},{t:this.item1}]}).wait(1));
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(3,1,1).p("Aqjh1IAAFnA1YjlInmAAIkTkkA1YBmICMCMIkZAAICNiMIAAlLA3lDyInCAAAqjIKIAAkYIopAAAsyjlIomAAAH3hCIEBEXEAhTADyMgr2AAA");
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AgTAZQgKgHAAgOQAAgNAIgLQAIgLAOAAQAKAAAHADQAJAFAAAJQAAAGgHAFIgNAGIgTAJQADADAEABQAEACAEAAQAIAAAFgEQAFgCADAAQAGAAAAAGQAAAGgKAEQgIAEgJAAQgNAAgJgHgAgHgNQgEADgCAIIANgGIALgHQgDgCgHAAQgEAAgEAEg");
	this.shape_13.setTransform(53.3,10.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("");
	this.shape_14.setTransform(45.5,10.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AAMAdQgIADgHAAQgIAAgGgEQgGgEgBgHQgDgPAAgKQAAgIACgKQABgGAHAAQADAAADACQACACAAADIgBAIIAAAIIAAAOIACAKIADABIACAAQAGAAAIgCIAAgKIgBgJIABgUQABgHAHAAQAEAAACACQADACAAADIgBAVIAAALIAAAMIAAADIAAAEQAAADgCACQgDACgDAAQgFAAgCgEg");
	this.shape_15.setTransform(37.6,10.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AgFAuQgCgCAAgEIAAhQQAAgDACgCQACgCADAAQAEAAACACQACACAAADIAABNQAAALgIAAQgDAAgCgCg");
	this.shape_16.setTransform(32.8,8.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgSAZQgJgIAAgOQgBgMAIgKQAJgMAPAAQALAAAHAJQAGAJAAAMQAAANgHAJQgIALgNAAQgKAAgIgHgAgHgJQgEAGAAAGQAAAHAEAEQADADAEAAQAEAAAEgEQAEgEABgHQABgRgLgBQgGAAgEAHg");
	this.shape_17.setTransform(28,10.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AgMAqQgHgRgJgfIgEgQQgEgLAAgFQAAgDADgCQACgCADAAQAGAAACAFIACALIAHATIAIAcIANgiIAFgOQADgJAFgEQACgDADAAQAEAAACACQADACAAAEQAAAAAAABQAAABAAAAQgBABAAAAQAAABgBAAIgFALIgFAMIgQAoIgGAOQgDAEgDAAQgGAAgDgFg");
	this.shape_18.setTransform(21,9.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_goNext},{t:this.btn_goBack},{t:this.instance_2},{t:this.vol_dwn},{t:this.vol_up},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.btn_menu}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/bgmusic.mp3?1501103018722", id:"bgmusic"},
		{src:"sounds/bgmusic2.mp3?1501103018722", id:"bgmusic2"},
		{src:"sounds/_3a.mp3?1501103018722", id:"_3a"},
		{src:"sounds/_4b.mp3?1501103018722", id:"_4b"},
		{src:"sounds/wrong_answer.mp3?1501103018722", id:"wrong_answer"},
		{src:"sounds/SENameofIdea.mp3?1501103018722", id:"SENameofIdea"},
		{src:"sounds/_7a.mp3?1501103018722", id:"_7a"},
		{src:"sounds/highclick.mp3?1501103018722", id:"highclick"},
		{src:"sounds/lowclick.mp3?1501103018722", id:"lowclick"},
		{src:"sounds/parrotmove1.mp3?1501103018722", id:"parrotmove1"},
		{src:"sounds/parrotmove2.mp3?1501103018722", id:"parrotmove2"},
		{src:"sounds/SENameOfPerson.mp3?1501103018722", id:"SENameOfPerson"},
		{src:"sounds/_6b.mp3?1501103018722", id:"_6b"},
		{src:"sounds/_2a.mp3?1501103018722", id:"_2a"}
	],
	preloads: []
};
