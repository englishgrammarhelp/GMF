...
(lib.intro_Scene1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{scene1:0,scene1_repeat:38});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(2).call(this.frame_2).wait(35).call(this.frame_37).wait(11).call(this.frame_48).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.btn_goNext},{t:this.instance_2},{t:this.btn_menu},{t:this.volume}]}).wait(49));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(289.1,198.2,532.2,404.8);
// library properties:
lib.properties = {
