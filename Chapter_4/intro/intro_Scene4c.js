...
(lib.intro_Scene4c = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(19).call(this.frame_19).wait(15).call(this.frame_34).wait(75).call(this.frame_109).wait(17).call(this.frame_126).wait(79).call(this.frame_205).wait(12).call(this.frame_217).wait(88).call(this.frame_305).wait(87).call(this.frame_392).wait(9).call(this.frame_401).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.btn_goNext},{t:this.btn_goBack},{t:this.instance_1},{t:this.btn_menu},{t:this.volume}]}).wait(402));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/bgmusic.mp3?1502225002190", id:"bgmusic"},
		{src:"sounds/gerunddefinitions.mp3?1502225002190", id:"gerunddefinitions"},
		{src:"sounds/gerunds.mp3?1502225002190", id:"gerunds"},
		{src:"sounds/infinitivedefinitions.mp3?1502225002190", id:"infinitivedefinitions"},
		{src:"sounds/infinitives.mp3?1502225002190", id:"infinitives"},
		{src:"sounds/participledef2.mp3?1502225002190", id:"participledef2"},
		{src:"sounds/participles.mp3?1502225002190", id:"participles"},
		{src:"sounds/participlesdef1.mp3?1502225002190", id:"participlesdef1"}
	],
	preloads: []
};
